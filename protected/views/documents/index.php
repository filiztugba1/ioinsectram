						...
						<div class="col-xl-12 col-lg-12 col-md-12 mb-1">
							...
							<fieldset class="form-group">
								...
								<!-- <option value="-1">Yanl�zca Sen</option> -->
										<?if(intval($ax->id)!==1){?><option value="0"><?=t('All');?></option><?}?>
										<?
...
function updateFileLabel(input) {
    var labelText = "Custom Choose Files"; /* Değiştirmek istediğiniz metni burada belirtin */
    var label = input.parentNode.previousElementSibling; // Dosyanın üzerindeki etiket
