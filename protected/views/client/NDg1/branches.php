...
<?=User::model()->geturl('Client','Branch Homepage',$_GET['id'],'client');?>
	...
	<div class="col-xl-12 col-lg-12 col-md-12">
			...
			<div class="card-header" style="">
					...
					<?php if (Yii::app()->user->checkAccess('client.branch.department.view')){ ?>
					  <li class="nav-item">
                        <a class="nav-link"  href="<?=Yii::app()->baseUrl?>/client/departments/<?=$_GET['id'];?>" ><span class="btn-effect2" style="font-size: 15px;"><?php echo count( $department);?></span><?=t('Departments');?></a></a>
                      </li>
					<?php }?>
