...
$veriler = $veriler. '
      <tr style="background-color:gray;">
			<td align="center" colspan="7">'.$bfrdate.'</td>
			</tr>
        ';
$i=0;
...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td colspan="5" align="center">
			<b><h2>Haşere Kontrol Formu</h2></b>
			<br><h3>(Böcekler)</h3>
		</td>
	</tr>
	<tr>
		<td colspan="7">Müşteri Adı (Client Name): <b> '.$monitor->clientname.'</b></td>
	</tr>
	<tr>
		<td colspan="7">Rapor Kriterleri: '.t($monitype->name)." ".t($monitype->detailed).'  <br> '.$kriterler.'</td>
	</tr>
	<tr>
		<td colspan="7">Tarih (Date): '.$_POST['Monitoring']['date'].' / '.$_POST['Monitoring']['date1'].'</td>
	</tr>
	<tr>
		<td colspan="7">Kontrol Eden (Kontroller) - İmza (Signature):</td>
	</tr>
