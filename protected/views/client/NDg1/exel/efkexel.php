...
foreach ($monitors as $monitor) {
        ...
        if ($bfrdate != date("d-m-Y", $monitor->checkdate)) {
            $veriler = $veriler . '
                <tr >
                <td style="background-color:gray;" align="center" colspan="13">' . date("d-m-Y", $monitor->checkdate) . '</td>
                </tr>
            ';
        }
   ...
   if($reportz)
  {
     if($reportz->value==1){ $yazdurum=t("TNW"); }
        ...
        <tr>
                ...
                <td align="left" colspan="2">' . $subdepartment->name . '</td>
...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td align="center">'.t('Conformity Number').'</td>
