                           ...
                           if(isset($_POST["Monitoring"]["subid"]))
                            ...
                            foreach ($monitors as $monitor)
                            {
                                ...
                                <tr>
									...
									<td>
									<?if($monitor->active==1){echo t('Active');}else{echo 'Passive';}?>
									</td>
									<td>
									<?if($monitor->createdtime!=0){echo date('Y-m-d',$monitor->createdtime);}?>
									</td>
									<td>
									<?if($monitor->passivetime!=0){echo date('Y-m-d',$monitor->passivetime);}else{echo '-';}?>
									</td>
                                </tr>
                            <?php } ?>
                            </tbody>
