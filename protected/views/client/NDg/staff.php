		...
		<div class="card-header" style="">
			<ul class="nav nav-tabs">
				...
				<?php if (Yii::app()->user->checkAccess('client.branch.view')) { ?>
					<li class="nav-item">
						<a class="nav-link" href="<?= Yii::app()->baseUrl ?>/client/view/<?= $_GET['id']; ?>"><span
								class="btn-effect2"
				...
				<?php if (Yii::app()->user->checkAccess('client.staff.view')) { ?>
					<li class="nav-item">
						<a class="nav-link active" href="<?= Yii::app()->baseUrl ?>/client/staff/<?= $_GET['id']; ?>"><span
				...
				<?php if ($ax->type == 23 || $ax->type == 13 || $ax->id == 1) { ?>
					<li class="nav-item">
						<a class="nav-link" href="<?= Yii::app()->baseUrl ?>/client/financials?id=<?= $_GET['id']; ?>"><span
			...
			<div class="col-xl-12 col-lg-12 col-md-12">
				<div class="card">
							...
							<div class="card-body">
								...
								<div class="row">
									...
									<?php if ($ax->firmid != '') {
										...
										if ($firm && $firm->package == 'Packagelite') { ?>
					...
					-->
									...
									<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
										<label for="basicSelect"><?= t('Birdh Place'); ?></label>
										<fieldset class="form-group">
											<input type="text" class="form-control" id="basicInput"
									...
									<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
										<label for="basicSelect"><?= t('Birdh Date'); ?></label>
										<fieldset class="form-group">
											...
											<div class="text-center">
												...
												<div class="text-center" style="margin-bottom:10px">
													<?php if (Yii::app()->user->checkAccess('client.staff.update')) {
														...
														$authuser = explode('.', $user[$i]['itemname']);
														?>
														<a class="btn btn-warning btn-sm" onclick="openmodal(this)"
															...
															data-auth="<?= isset($authuser[4]) ? $authuser[4] : ''; ?>"
															data-conformityemail="<?php if (!$user[$i]['conformityemail']) {
																echo "1";
															} else {
																echo $user[$i]['conformityemail'];
															} ?>"
															data-serviceemail="<?php if (!$user[$i]['serviceemail']) {
																echo '0';
															} else {
																echo $user[$i]['serviceemail'];
															} ?>">
													...
													<?php if (Yii::app()->user->checkAccess('client.staff.delete') || $delisActive) { ?>

														<a class="btn btn-danger btn-sm" onclick="openmodalsil(this)"
															data-id="<?= $user[$i]['id']; ?>" data-userid="<?= $user[$i]['id']; ?>"><i
				...
				<div class="modal fade text-left" id="duzenle" tabindex="-1" role="dialog" aria-labelledby="myModalLabel8"
					...
					<div class="modal-dialog modal-lg" role="document">
						<div class="modal-content">
							...
							<form id="staffteamlist-form" action="<?=Yii::app()->baseUrl?>/staffteamlist/update/0" method="post">
								<div class="card-content">
									<div class="card-body">
											...
											<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
												...
												<fieldset class="form-group">
													<input type="text" class="form-control" id="modalstaffusername"
														...
														name="Staffteamlist[username]" required>
												</fieldset>
											</div>
											...
											<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
												...
												<fieldset class="form-group">
													<input type="text" class="form-control" id="modalstaffemail"
														placeholder="<?= t('Email'); ?>" name="Staffteamlist[email]" required>
												</fieldset>
											</div>
...
<script>
	...
	function authchange(data, permission, obj) {
		$.post("<?= Yii::app()->baseUrl ?>/client/authchange", { monitoringid: data, active: permission })
