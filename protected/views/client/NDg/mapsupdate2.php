...
<!-- HTML5 export buttons table -->
  ...
  <button id="close_monitor_selection">Kapat</button>
  <table class="table table-striped table-bordered dataex-html5-export table-responsive">
    ...
    <tbody>
      <?php 
        ...
        <?php    
          $departmentlists=Departments::model()->find(array(
								   #'select'=>'',
								   #'limit'=>'5',
								   'order'=>'name ASC',
          ...
          $monitoringtype=Monitoringtype::model()->find(array(
              ...
              <div class="logs">
                  <div class="top-buttons">
                    ...
                    <a href="/client/maps?id=<?=$_GET["id"]?>" class="btn btn-sm btn-primary">Map List</a>
...
<!--                      <button type="button" id="download_map">Download</button>-->
    ...
    var offsetX = 0//canvasOffset.left;
    var offsetY = 0//parseInt(window.pageYOffset) + parseInt(canvasOffset.top)
...
//        offsetY = parseInt(canvasOffset.top) - parseInt($("#drawArea").pageYOffset)// + parseInt(canvasOffset.top)
           console.log(offsetY)
    }
    ...
    function handleMouseDown(e) {
        ...
        var mouseX = parseInt(x)*(scale/100);
        var mouseY = parseInt(y)*(scale/100);
        isDown = true;
        startX = mouseX;
        startY = mouseY;
    ...
    function handleMouseUp(e) {
        isDown = false;
        var mouseX = parseInt(e.clientX +  offsetX)*(scale/100);
        var mouseY = parseInt(e.clientY +  offsetY)*(scale/100);
        let data = {
            id: UUID(),
            positionInfo: "",
            cnt: maxCntNum(),
