...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td rowspan="7" colspan="'.($firm->id!==412?6:5).'" align="center">
            <b><h2>'.t('Kemirgenler İçin Monitör Yerleşim Listesi').'y</h2></b>
   ...
   '.$mttd.'
    ...
    <tr>
        <td rowspan="'.($firm->country_id==1?'8':'5').'" colspan="'.($firm->id!==412?10:9).'" class="f12">'.t('Müşteri Adı (Client Name)').':<b> '.$client->name.'</b></td>
        <td>O</td>
