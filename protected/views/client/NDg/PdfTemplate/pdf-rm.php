...
$monitype=Monitoringtype::model()->findByPk($monitor->monitortype);
  ...
  $veriler= $veriler .'<tr>
    <td width="55"  align="center">'.$idms.'</td>
    <td width="50" align="center">'.t($monitor->detailed).' ('.t($monitor->name).')'.'</td>
    <td width="55" align="center">'.t($monitype->name).'</td>
    <td width="55" align="left" colspan="2">'.$bolum.'</td>';
