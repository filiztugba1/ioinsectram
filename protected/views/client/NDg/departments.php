...
if (Yii::app()->user->checkAccess('client.branch.department.view')) { ?>
        ...
        <div class="card-header" style="">
            <ul class="nav nav-tabs">
                <?php if (Yii::app()->user->checkAccess('client.branch.staff.view')) { ?>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= Yii::app()->baseUrl ?>/client/branchstaff/<?= $_GET['id']; ?>"><span
                ...
                <?php if (Yii::app()->user->checkAccess('client.branch.department.view')) { ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?= Yii::app()->baseUrl ?>/client/departments/<?= $_GET['id']; ?>"><span
                                class="btn-effect2"
                                style="font-size: 15px;"><?php echo count($departments); ?></span><?= t('Departments'); ?></a></a>
                    </li>
                <?php } ?>
                ...
                <?php if (Yii::app()->user->checkAccess('client.branch.reports.view') && $ax->clientid == 0) { ?>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= Yii::app()->baseUrl ?>/client/clientqr?id=<?= $_GET['id']; ?>"
                            target="_blank"><span class="btn-effect" style="font-size: 15px;"><i class="fa fa-qrcode"
                            ...
                            <div class="treex well">
                                <div class="col-md-12 text-center">
                                    ...
                                    if (Yii::app()->user->checkAccess('client.branch.department.create') && ($transfer != 1 || $ax->branchid == 0 || $ax->branchid == $tclient->firmid || ($ax->clientbranchid == 0 && $ax->clientid == $tclient->mainclientid))) { ?>
                                        <a onclick="openmodalcreate(this)" data-id="0" data-name=""
                                            class="btn btn-primary"><?= t('NEW DEPARTMENT ADD'); ?></a>
                                    <?php } ?>
                                </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form id="departments-form" action="/departments/create" method="post">
                            <input type="hidden" class="form-control" id="basicInput" name="Departments[clientid]"
                                value="<?= $_GET['id']; ?>">
                            <div class="modal-body">
                                <input type="hidden" class="form-control" id="modalcreateparentid"
                                    name="Departments[parentid]" value="0">

                                <div class="col-xl-12 col-lg-12 col-md-12 mb-1">
                                    <label for="basicSelect"><?= t('Name'); ?></label>
                                    <fieldset class="form-group">
                                        <input type="text" class="form-control" placeholder="<?= t('Name'); ?>"
                                            name="Departments[name]" value="">
                                    </fieldset>
                                </div>
            ...
            <div class="modal fade text-left" id="update" tabindex="-1" role="dialog" aria-labelledby="myModalLabel8"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <!--form baslang��-->
                        <form id="departments-form" action="<?=Yii::app()->baseUrl?>/departments/update/0" method="post">
                            <input type="hidden" class="form-control" id="basicInput" name="Departments[clientid]"
                                value="<?= $_GET['id']; ?>">
                            <div class="modal-body">
                                <input type="hidden" class="form-control" id="modalupdateid" name="Departments[id]"
                                    value="0">

                                <div class="col-xl-12 col-lg-12 col-md-12 mb-1">
                                    <label for="basicSelect"><?= t('Name'); ?></label>
                                    <fieldset class="form-group">
                                        <input type="text" class="form-control" id="modalupdatename"
                                            placeholder="<?= t('Name'); ?>" name="Departments[name]" value="">
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 mb-1">
                                    ...
                                    <fieldset class="form-group">
                                        <select class="custom-select block" id="modalupdateactive"
            ...
            <div class="modal fade text-left" id="delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel8"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <!--form baslang��-->
                        <form id="departments-form" action="<?=Yii::app()->baseUrl?>/departments/delete/0" method="post">
                            <input type="hidden" class="form-control" id="basicInput" name="Departments[clientid]"
                                value="<?= $_GET['id']; ?>">
...
<style>
    ...
    .treex li.parent_li>span:hover,
    .treex li.parent_li>span:hover+ul li span {
        background: #eee;
...
<script>
    ...
    function openmodalsubcreate(obj) {
        $('#h4create').html($(obj).data('name') + ' <?= t('New Sub Create') ?>');
