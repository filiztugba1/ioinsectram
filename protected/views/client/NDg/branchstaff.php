...
<?php if (Yii::app()->user->checkAccess('client.branch.staff.view')) { ?>
	...
	<div class="card">
		<div class="card-header" style="">
			<ul class="nav nav-tabs">
				<?php if (Yii::app()->user->checkAccess('client.branch.staff.view')) { ?>
					<li class="nav-item">
						<a class="nav-link active" href="<?= Yii::app()->baseUrl ?>/client/branchstaff/<?= $_GET['id']; ?>"><span
				...
				<?php if (Yii::app()->user->checkAccess('client.branch.department.view')) { ?>
					...
					<li class="nav-item">
						<a class="nav-link " href="<?= Yii::app()->baseUrl ?>/client/departments/<?= $_GET['id']; ?>"><span
								class="btn-effect2"
								style="font-size: 15px;"><?php echo count($departments); ?></span><?= t('Departments'); ?></a>
					</li>
				<?php } ?>
				<?php if (Yii::app()->user->checkAccess('client.branch.monitoringpoints.view')) { ?>
					<li class="nav-item">
						<a class="nav-link" href="<?= Yii::app()->baseUrl ?>/client/monitoringpoints/<?= $_GET['id']; ?>"><span
								class="btn-effect2"
				...
				<?php if (Yii::app()->user->checkAccess('client.branch.reports.view')) { ?>
					...
					<li class="nav-item">
						<a class="nav-link" href="<?= Yii::app()->baseUrl ?>/client/reports/<?= $_GET['id']; ?>"><span
				...
				<?php if (Yii::app()->user->checkAccess('client.branch.offers.view')) { ?>
					...
					<li class="nav-item">
						<a class="nav-link" href="<?= Yii::app()->baseUrl ?>/client/offers/<?= $_GET['id']; ?>"><span
				...
				<?php if (Yii::app()->user->checkAccess('client.branch.filemanagement.view')) { ?>
					...
					<li class="nav-item">
						<a class="nav-link" href="<?= Yii::app()->baseUrl ?>/client/files2/<?= $_GET['id']; ?>"><span
				...
				<li class="nav-item">
					<a class="nav-link" href="<?= Yii::app()->baseUrl ?>/client/clientqr?id=<?= $_GET['id']; ?>" target="_blank"><span
		...
		<div class="row" id="createpage">
			...
			<div class="col-xl-12 col-lg-12 col-md-12">
				...
				<div class="card">
					...
					<form id="staffteamlist-form" action="<?= Yii::app()->baseUrl ?>/staffteamlist/create" method="post">
						<div class="card-content">
							<div class="card-body">

								<input type="hidden" class="form-control" id="basicInput" name="Staffteamlist[branchid]"
									value="<?= $_GET['id']; ?>">
								...
								<div class="row">
									...
									<?php if ($ax->firmid != '') {
										...
										if (isset($firm->package) && $firm->package == 'Packagelite') { ?>
							...
							-->
									...
									<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
										...
										<fieldset class="form-group">
											<input type="text" class="form-control" id="username" onkeyup="javascript:kontrol()"
												placeholder="<?= t('User Name'); ?>" name="Staffteamlist[username]" required>
										</fieldset>
									</div>
									...
									<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
										...
										<fieldset class="form-group">
											<input type="password" class="form-control" id="password"
												placeholder="<?= t('Password'); ?>" name="Staffteamlist[password]"
									...
									<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
										...
										<fieldset class="form-group">
											<input type="text" class="form-control" id="email" placeholder="<?= t('Email'); ?>"
												name="Staffteamlist[email]" required>
										</fieldset>
									</div>
									...
									<div class="col-xl-6 col-lg-6 col-md-6 mb-1">
										...
										<fieldset class="form-group">
											<input type="text" class="form-control" id="basicInput"
												placeholder="<?= t('Name'); ?>" name="Staffteamlist[name]">
										</fieldset>
									</div>
									...
									<div class="col-xl-6 col-lg-6 col-md-6 mb-1">
										...
										<fieldset class="form-group">
											<input type="text" class="form-control" id="basicInput"
												placeholder="<?= t('Surname'); ?>" name="Staffteamlist[surname]">
										</fieldset>
									</div>
					...
					-->
									<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
										...
										<fieldset class="form-group">
											<input type="text" class="form-control" id="basicInput"
												placeholder="<?= t('Birth Place'); ?>" name="Staffteamlist[birthplace]">
										</fieldset>
									</div>
									...
									<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
										...
										<fieldset class="form-group">
											<input type="date" class="form-control" id="basicInput"
												placeholder="<?= t('Birth Date'); ?>" name="Staffteamlist[birthdate]">
										</fieldset>
									</div>
									...
									<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
										...
										<fieldset class="form-group">
											<select class="custom-select block" id="userlgid" name="Staffteamlist[userlgid]"
												required>
									...
									<div class="col-xl-6 col-lg-6 col-md-6 mb-1">
										...
										<fieldset class="form-group">
											<input type="text" class="form-control" id="basicInput"
												placeholder="<?= t('Phone'); ?>" name="Staffteamlist[phone]">
										</fieldset>
									</div>
									...
									<div class="col-xl-12 col-lg-12 col-md-12 mb-1">
										...
										<fieldset class="form-group">
											<div class="input-group-append" id="button-addon2" style='float:right'>
												<button class="btn btn-primary block-page-create"
							...
							<?php if (Yii::app()->user->checkAccess('client.branch.staff.create') && ($transfer != 1 || $ax->branchid == 0 || $ax->branchid == $tclient->firmid || ($ax->clientbranchid == 0 && $ax->clientid == $tclient->mainclientid))) { ?>
								<div class="col-xl-3 col-lg-3 col-md-3 mb-1">
									<div class="input-group-append" id="button-addon2" style="float: right; text-align: right;">
										<button class="btn btn-info" id="createbutton" type="submit"><?= t('Add Staff'); ?> <i
					...
					<div class="card-content collapse show">
						<div class="card-body card-dashboard">
							...
							<fieldset class="form-group position-relative">
								<input type="text" class="form-control form-control-xl input-xl" id="staffsearch"
							...
							<input type="hidden" class="form-control form-control-xl input-xl" id="branchid"
								value="<?= $_GET['id']; ?>">
											...
											<div class="text-center">
												...
												<?php if ($user[$i]['active'] == 1) { ?>
													<a class="btn btn-success btn-sm"
														style='float:right;color:#fff'><?= t('Active'); ?> </a>
												<?php } else { ?> <a class="btn btn-danger btn-sm"
														style='float:right;color:#fff'><?= t('Passive'); ?> </a><?php } ?>


												<div class="card-body">
													<img src="<?php if ($user[$i]['gender'] == 0) { ?><?= Yii::app()->theme->baseUrl . '/app-assets/images/staff-logo-mr.png'; ?><?php } else { ?><?= Yii::app()->theme->baseUrl . '/app-assets/images/staff-logo-mrs.png'; ?><?php } ?>"
														class="rounded-circle  height-150"
														alt="<?= $user[$i]['name'] . ' ' . $user[$i]['surname']; ?>">
												</div>
												<div class="card-body">
													...
													<h6 class="card-subtitle" style='margin-top: 14px;'>
														<?= $user[$i]['primaryphone']; ?></h6>
												</div>
												<div class="text-center" style="margin-bottom:10px">

													<?php
													if (Yii::app()->user->checkAccess('client.branch.staff.update') && ($transfer != 1 || $ax->branchid == 0 || $ax->branchid == $tclient->firmid || ($ax->clientbranchid == 0 && $ax->clientid == $tclient->mainclientid))) { ?>
														<a class="btn btn-warning btn-sm" onclick="openmodal(this)"
															...
															data-userid="<?= $user[$i]['id']; ?>"
															data-active="<?= $user[$i]['active']; ?>"
															<?php 
															$authname=AuthAssignment::model()->find(array('condition' => 'userid=' . $user[$i]['userid']));
															$authuser = explode('.', isset($authname->itemname)?$authname->itemname:''); ?>
															data-auth="<?= isset($authuser[5])?$authuser[5]:''; ?>" data-type="<?= $user[$i]['type']; ?>"
															<?php $conformityemail = Generalsettings::model()->find(array(
																'condition' => 'name=:name and userid=:userid',
																'params' => array('name' => 'conformityemail', 'userid' => $user[$i]['id'])
															));

															?>
															data-conformityemail="<?php if (!$conformityemail) {
																echo "1";
															} else {
																echo $conformityemail->type;
															} ?>"
															<?php $serviceemail = Generalsettings::model()->find(array(
																'condition' => 'name=:name and userid=:userid',
																'params' => array('name' => 'serviceemail', 'userid' => $user[$i]['id'])
															));

															?>
															data-serviceemail="<?php if (!$serviceemail) {
																echo '0';
															} else {
																echo $serviceemail->isactive;
															} ?>"><i
													...
													<?php if ($transfer != 1 || $ax->branchid == 0 || $ax->branchid == $tclient->firmid || ($ax->clientbranchid == 0 && $ax->clientid == $tclient->mainclientid)) {
														...
														if ($ax->clientid > 0 && $ax->clientbranchid == 0) { ?>
															<a href="<?= Yii::app()->baseUrl ?>/client/auth/<?= $user[$i]['id']; ?>"
																class="btn btn-primary btn-sm"><i style="color:#fff;"
													...
													<?php if (Yii::app()->user->checkAccess('client.branch.staff.update') && ($transfer != 1 || $ax->branchid == 0 || $ax->branchid == $tclient->firmid || ($ax->clientbranchid == 0 && $ax->clientid == $tclient->mainclientid))) { ?>
														<a href="<?= Yii::app()->baseUrl ?>/userinfo/update/<?= $user[$i]['id']; ?>"
															class="btn btn-info btn-sm"><i style="color:#fff;"
																class="fa fa-info"></i></a>

													<?php } ?>

													<?php if ((Yii::app()->user->checkAccess('client.branch.staff.delete') && ($transfer != 1 || $ax->branchid == 0 || $ax->branchid == $tclient->firmid || ($ax->clientbranchid == 0 && $ax->clientid == $tclient->mainclientid))) || $delisActive) { ?>
														<a class="btn btn-danger btn-sm" onclick="openmodalsil(this)"
															data-id="<?= $user[$i]['id']; ?>"
															data-userid="<?= $user[$i]['userid']; ?>"><i style="color:#fff;"
	...
	<?php if (Yii::app()->user->checkAccess('client.branch.staff.update')) { ?>
						...
						<div class="modal-content">
							...
							<form id="staffteamlist-form" action="/staffteamlist/update/0" method="post">
								<div class="card-content">
									<div class="card-body">
										...
										<input type="hidden" class="form-control" id="modalstaffuserid"
											name="Staffteamlist[userid]">
										<input type="hidden" class="form-control" id="basicInput" name="type" value="branch">
							...
							-->
											...
											<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
												<label for="basicSelect"><?= t('User Name'); ?></label>
												<fieldset class="form-group">
													<input type="text" class="form-control" id="modalstaffusername"
														onkeyup="javascript:kontrolupdate()" placeholder="<?= t('User Name'); ?>"
														required name="Staffteamlist[username]">
												</fieldset>
											</div>
											...
											<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
												...
												<fieldset class="form-group">
													<input type="text" class="form-control" id="modalstaffemail"
														placeholder="<?= t('Email/User Name'); ?>" required
														name="Staffteamlist[email]">
												</fieldset>
											</div>
											...
											<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
												<label for="basicSelect"><?= t('Surname'); ?></label>
												<fieldset class="form-group">
													<input type="text" class="form-control" id="modalstaffsurname"
														placeholder="<?= t('Surname'); ?>" name="Staffteamlist[surname]">
												</fieldset>
											</div>
											...
											<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
												<label for="basicSelect"><?= t('Phone'); ?></label>
												<fieldset class="form-group">
													<input type="text" class="form-control" id="modalstaffphone"
														placeholder="<?= t('Phone'); ?>" name="Staffteamlist[phone]">
												</fieldset>
											</div>
											...
											<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
												<label for="basicSelect"><?= t('Birth Place'); ?></label>
												<fieldset class="form-group">
													<input type="text" class="form-control" id="modalstaffbirthplace"
														placeholder="<?= t('Birth Place'); ?>" name="Staffteamlist[birthplace]">
												</fieldset>
											</div>
											...
											<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
												<label for="basicSelect"><?= t('Birth Date'); ?></label>
												<fieldset class="form-group">
													<input type="date" class="form-control" id="modalstaffbirthdate"
														placeholder="<?= t('Birth Date'); ?>" name="Staffteamlist[birthdate]">
												</fieldset>
											</div>
											...
											<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
												<label for="basicSelect"><?= t('LANGUAGE'); ?></label>
												<fieldset class="form-group">
													<select class="custom-select block" id="modaluserlgid"
														name="Staffteamlist[userlgid]" required>
														<option value=''><?= t('Select'); ?></option>
														<?php foreach ($languages as $language): ?>
															<option value="<?= $language->id; ?>"><?= $language->name; ?></option>
														<?php endforeach; ?>
											...
											<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
												<label for="basicSelect"><?= t('Gender'); ?></label>
												<fieldset class="form-group">
													<select class="custom-select block" id="modalstaffgender"
														name="Staffteamlist[gender]">
														<option value="0"><?= t('Mr'); ?></option>
														<option value="1"><?= t('Mrs'); ?></option>
											...
											<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
												...
												<fieldset class="form-group">
													<select class="custom-select block" id="modalconformityemail"
														name="Conformity[ismail]">
											...
											<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
												<label for="basicSelect"><?= t('Service report email is active?'); ?></label>
												<fieldset class="form-group">
													<select class="custom-select block" id="modalserviceemail"
														name="Conformity[isservicemail]">
														<option value="1"><?= t('Active'); ?></option>
														<option value="0"><?= t('Passive'); ?></option>
													</select>
												</fieldset>
											...
											<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
												...
												<fieldset class="form-group">
													<select class="custom-select block" id="modalactive"
														name="Staffteamlist[active]">
										...
										<div class="modal-footer">
											...
											<button class="btn btn-warning block-page-update"
		...
		<!-- GÜNCELLEME BİTİŞ-->
	<?php } ?>
	<?php if (Yii::app()->user->checkAccess('client.branch.staff.delete') || $delisActive) { ?>
		<!--SİL BAŞLANGIÇ-->
				...
				<div class="modal fade text-left" id="sil" tabindex="-1" role="dialog" aria-labelledby="myModalLabel8"
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<!--form baslangıç-->
							<form id="staffteamlist-form" action="<?= Yii::app()->baseUrl ?>/staffteamlist/delete/0" method="post">
...
<script>
	...
	function openmodal(obj) {
		...
		$('#modalserviceemail').val($(obj).data('serviceemail'));
	...
	$(function () {
		$('#staffsearch').keyup(function () {
			...
			$.post("<?= Yii::app()->baseUrl ?>/client/staffsearch?id=" + branchid + '&&ara=' + staff).done(function (data) {
				$('#staffteam').html(data);
