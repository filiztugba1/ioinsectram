...
$firm=Client::model()->findAll(array(
								   'condition'=>'parentid=:parentid and isdelete=0','params'=>array('parentid'=>$staff->clientid)
							   ));
							  ...
							  ?>
                                <tr>
									...
									<div class="form-group pb-1">
										<input type="checkbox" id="switchery" data-size="sm"  class="switchery" data-id="<?=Authassignment::model()->getclientauthname($firms->id).'|'.$staffid?>"  <?php if($authok){echo "checked";}?>  
