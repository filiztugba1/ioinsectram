...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'taxoffice',array('size'=>60,'maxlength'=>255)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'taxno'); ?>
		<?php echo $form->textField($model,'taxno',array('size'=>60,'maxlength'=>255)); ?>
	</div>
