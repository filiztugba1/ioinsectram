...
<?php if (Yii::app()->user->checkAccess('education.view')){ ?>
<?=User::model()->geturl('Education','',0,'educateion');?>
<?php if (Yii::app()->user->checkAccess('education.create')){ ?>
<div class="row" id="createpage" >
	<div class="col-xl-12 col-lg-12 col-md-12">
			...
			<div class="card">
					 ...
					 <div class="col-md-6">
                  <h4  class="card-title"><?=t('New Education Create');?></h4>
					</div>
					 <div class="col-md-6">
				...
				<div class="card-content">
					...
					<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
                        <fieldset class="form-group">
                          <input type="text" class="form-control" id="basicInput" placeholder="<?=t('Name');?>" name="Education[name]">
                        </fieldset>
                    </div>
                ...
                <div class="card-header">
					<div class="row" style="border-bottom: 1px solid #e3ebf3;">
					   <div class="col-xl-9 col-lg-9 col-md-9 mb-1">
						 <h4 class="card-title"><?=t('EDUCATION LIST');?></h4>
						</div>
						<div class="col-xl-3 col-lg-3 col-md-3 mb-1">
								<div class="input-group-append" id="button-addon2" style="float: right; text-align: right;">
									<button class="btn btn-info" id="createbutton" type="submit"><?=t('Add Education');?> <i class="fa fa-plus"></i></button>
								</div>
                      ...
                      <table class="table table-striped table-bordered dataex-html5-export">
                        ...
                        <tbody>
             			<?php foreach($education as $educations):?>
                                <tr>
								<td><input type="checkbox" name="Education[id][]" class='sec' value="<?=$educations->id;?>"></td>
                                    <td><?=t($educations->name);?></td>

									<td>
									<?php if (Yii::app()->user->checkAccess('education.update')){ ?>
										 <a  class="btn btn-warning btn-sm" onclick="openmodal(this)" data-id="<?=$educations->id;?>" data-name="<?=$educations->name;?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?=t('Update');?>"><i style="color:#fff;" class="fa fa-edit"></i></a>
									<?php }?>
									<?php if (Yii::app()->user->checkAccess('education.delete')){ ?>
									<a class="btn btn-danger btn-sm" onclick="openmodalsil(this)" data-id="<?=$educations->id;?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?=t('Delete');?>"><i style="color:#fff;" class="fa fa-trash"></i></a>
									<?php }?>
									</td>
                                </tr>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header bg-warning white">
                            <h4 class="modal-title" id="myModalLabel8"><?=t('Education Update');?></h4>
					...
					<!--form baslangıç-->
						<form id="education-form" action="/education/update/0" method="post">
                            <div class="modal-body">
								<input type="hidden" class="form-control" id="modaleducationid" name="Education[id]" value="0">
								<div class="col-xl-12 col-lg-12 col-md-12 mb-1">
								<label for="basicSelect"><?=t('Name');?></label>
									<fieldset class="form-group">
										<input type="text" class="form-control" id="modaleducationname" placeholder="<?=t('Name');?>" name="Education[name]" value="">
									</fieldset>
								</div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header bg-danger white">
                            <h4 class="modal-title" id="myModalLabel8"><?=t('Education Delete');?></h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
                            </button>
                        </div>
					...
					<!--form baslangıç-->
						<form id="education-form" action="/education/delete/0" method="post">

						<input type="hidden" class="form-control" id="modaleducationid2" name="Education[id]" value="0">
	...
	<!--delelete all start-->
        ...
        <div class="form-group">
            ...
            <div class="modal fade text-left" id="deleteall" tabindex="-1" role="dialog" aria-labelledby="myModalLabel8"
				...
				<!--form baslangıç-->
						<form action="/education/deleteall" method="post">

						<input type="hidden" class="form-control" id="modalid3" name="Education[id]" value="0">
...
{
	$('#modaleducationid').val($(obj).data('id'));
	$('#modaleducationname').val($(obj).data('name'));
	$('#duzenle').modal('show');
...
{
	$('#modaleducationid2').val($(obj).data('id'));
	$('#sil').modal('show');
