...
<!-- Sayfada neredeyiz -->
<?=User::model()->geturl(t('Stok Kimyasal Kullanım'),$stokkimyasalkullanim->kimyasaladi.' '.t('hedeflenen zararlı listesi'),1,'stokkimyasalkullanim/view');?>
		...
		<div class="card">
			<div class="card-header">
				<div class="row" style="padding-bottom: 10px;border-bottom: 1px solid #f8f8f9;">
					<div class="col-md-6">
						<h4  class="card-title"><?=$stokkimyasalkullanim->kimyasaladi;?> <?=t('hedef zararlı ekleme');?></h4>
					</div>
					<div class="col-md-6">
				...
				<div class="card-content">
					<div class="card-body">
						<div class="row">
							...
							<label for="basicSelect"><?=t('Monitor Tipi');?></label>
							<fieldset class="form-group">
								...
								<?
								// $mtypes=Monitoringtype::model()->findAll(array('condition'=>'active=1'));
									foreach($monitoringtypes as $mtype)
								...
								<div class="col-xl-6 col-lg-6 col-md-6 mb-1">
								<label for="basicSelect"><?=t('Hedef Canlı');?></label>
								<fieldset class="form-group">
								...
								<div class="col-xl-6 col-lg-6 col-md-6 mb-1">
									<label for="basicSelect"><?=t('Dozaj');?></label>
								 	<fieldset class="form-group">
								...
								<div class="col-xl-6 col-lg-6 col-md-6 mb-1">
									<fieldset class="form-group">
										<label for="basicSelect"><?=t('Birim');?></label>
        ...
        <div class="card-header">
					<div class="row" style="border-bottom: 1px solid #e3ebf3;">
					   <div class="col-xl-9 col-lg-9 col-md-9 mb-1">
						     <h4 class="card-title"><?=$stokkimyasalkullanim->kimyasaladi;?> <?=t('hedeflenen zararlı listesi');?></h4>
						 </div>
						<?php if (Yii::app()->user->checkAccess('medfirms.create')){ ?>
                ...
                <thead>
                	...
                	<tbody>
		              ...
		              <tr>
		                ...
		                <td><?
										$petname=Pets::model()->find(array('condition'=>'id='.$stokkimyasalkullanim->petsid))->name;
										echo $petname;?></td>
