...
<?php if (Yii::app()->user->checkAccess('notifications.view')){ ?>
	...
	<!-- Sayfada neredeyiz -->
<?=User::model()->geturl('Notifications','',0,'notifications');?>
                ...
                <div class="card-header">
					<div class="row" style="border-bottom: 1px solid #e3ebf3;">
					   <div class="col-xl-9 col-lg-9 col-md-9 mb-1">
						 <h4 class="card-title"><?=t('NOTIFICATION LIST');?></h4>
						</div>

						<?php if (Yii::app()->user->checkAccess('notifications.create')){ ?>
						<div class="col-xl-3 col-lg-3 col-md-3 mb-1">
								<div class="input-group-append" id="button-addon2" style="float: right; text-align: right;">
									<button class="btn btn-info" id="createbutton" type="submit"><?=t('Add Notification');?> <i class="fa fa-plus"></i></button>
								</div>
                  ...
                  <div class="card-body">
                    <ul class="nav nav-tabs nav-underline">
                      <li class="nav-item">
                        ...
                        href="#tabIcon21" aria-expanded="true"><i class="fa fa-arrow-circle-o-down"></i><?=t('Incoming Notification');?></a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" id="baseIcon-tab22" data-toggle="tab" aria-controls="tabIcon22"
                        href="#tabIcon22" aria-expanded="false"><i class="fa fa-arrow-circle-o-up"></i><?=t('Outgoing Notification');?></a>
                      </li>
