			...
			<div class="card">
				 <div class="card-header">
						 <div class="row" style="padding-bottom: 10px;border-bottom: 1px solid #f8f8f9;">
							 <div class="col-md-6">
								  <h4  class="card-title"><?=t('New Pet Create');?></h4>
									</div>
									 <div class="col-md-6">
				...
				<form id="pets-form" action="/pets/create" method="post">
				<div class="card-content">
					...
					<label for="basicSelect"><?=t('Name');?></label>
                        <fieldset class="form-group">
                          <input type="text" class="form-control" id="basicInput" placeholder="<?=t('Name');?>" name="Pets[name]">
                        </fieldset>
                    </div>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
                        ...
                        <fieldset class="form-group">
                          	<input value="ffcc00" id='color' onchange='colorchange()' class="form-control jscolor {position:'right', borderColor:'#FFF', insetColor:'#FFF', backgroundColor:'#666'}"  name="Pets[color]" required>
						</fieldset>
                    </div>
                ...
                <div class="card-header">
					<div class="row" style="border-bottom: 1px solid #e3ebf3;">
					   <div class="col-xl-9 col-lg-9 col-md-9 mb-1">
						 <h4 class="card-title"><?=t('PETS LIST');?></h4>
						</div>

						<div class="col-xl-3 col-lg-3 col-md-3 mb-1">
								<div class="input-group-append" id="button-addon2" style="float: right; text-align: right;">
									<button class="btn btn-info" id="createbutton" type="submit"><?=t('Add Pets');?> <i class="fa fa-plus"></i></button>
								</div>
                        ...
                        <tbody>
             				<?php foreach($pets as $pet):?>
                                <tr>
									...
									<td><div class="card-title" style="background:#<?=$pet->color;?>;height:5px"></div></td>
									<td>
										 <a  class="btn btn-warning btn-sm" onclick="openmodal(this)" data-id="<?=$pet->id;?>" data-name="<?=$pet->name;?>"  ><i style="color:#fff;" class="fa fa-edit"></i></a>

										<a class="btn btn-danger btn-sm" onclick="openmodalsil(this)" data-id="<?=$pet->id;?>"><i style="color:#fff;" class="fa fa-trash"></i></a>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header bg-warning white">
                            <h4 class="modal-title" id="myModalLabel8"><?=t('Pet Update');?></h4>
					...
					<!--form baslang��-->
						<form id="pets-form" action="/pets/update/0" method="post">
                            <div class="modal-body">
								<input type="hidden" class="form-control" id="modalpetsid" name="Pets[id]" value="0">
								<div class="col-xl-12 col-lg-12 col-md-12 mb-1">
								<label for="basicSelect"><?=t('Name');?></label>
									<fieldset class="form-group">
										<input type="text" class="form-control" id="modalpetsname" placeholder="<?=t('Name');?>" name="Pets[name]" value="">
									</fieldset>
								</div>
...
<div class="col-xl-12 col-lg-12 col-md-12 mb-1">
						<label for="basicSelect"><?=t('Color');?></label>
                        <fieldset class="form-group">
                          	<input value="ffcc00" id='color2' onchange='colorchange2()' class="form-control jscolor {position:'right', borderColor:'#FFF', insetColor:'#FFF', backgroundColor:'#666'}"  name="Pets[color]" required>
						</fieldset>
                    </div>
                            </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header bg-danger white">
                            <h4 class="modal-title" id="myModalLabel8"><?=t('Pet Delete');?></h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
                            </button>
                        </div>
					...
					<!--form baslang��-->
						<form id="pets-form" action="/pets/delete/0" method="post">

						<input type="hidden" class="form-control" id="modalpetsid2" name="Pets[id]" value="0">
 ...
 $("#cancel").click(function(){
	...
	function colorchange()
	{
		var color=document.getElementById("color").value;
		 $.post( "/pets/color?ara="+color).done(function( data ) {
			//$('#staffteam').html(data);
			if(data==1)
			{
