...
<div class="row" id="" >
	<div class="col-xl-12 col-lg-12 col-md-12">
		<div class="card">
			...
			<form id="workorder-save" onsubmit="return validateForm()" action="<?php if(isset($_GET['id']) && $_GET['id']!="" && $_GET['id']!=0){echo "/workorderperiyodik/update?id=".$_GET['id'];}else{echo "/workorderperiyodik/create";}?>" method="post">
							...
							<label for="basicSelect"><?=t('Workorder Period');?></label>
								<fieldset class="form-group">
									...
									<select class="select2" id="applyw" onchange="uperiod()" style="width:100%" name="Workorderisperiod[updateperiod]">
										...
										<!--	<option  value="2" ><?=t('Apply to open workorder');?></option> -->
...
<?php if(!$a){?>
                        ...
                        <div class="input-group-append" id="workorderupdate" style="float:right">
								...
								<button class="btn btn-primary" id="kydt" type="submit"><?=t('Save');?></button>
							</div>
                        </fieldset>
                    </div>
...
$(document).ready(function() {
    $('form').on('submit', function() {
        $('#kydt').prop('disabled', true).text('<?=t("Saving...")?>');
    });
});
</script>
<?php
...
function workorderisperiodfirst()
 ...
 function workorderisperiod()
 {
	  ...
	  if(isperiod==1)
	  {
		  ...
		  {?>
			// $("#workorderupdate").html('<a class="btn btn-danger btn-sm" id="sl" onclick="workordersil(this)" data-id="<?=$_GET['id'];?>" style="line-height: 29px;color: #fff;margin-right: 5px;font-size: 14px;"><?=t('Delete');?></a><button class="btn btn-primary" onclick="clicked(); return false;"><?=t('Regenerate');?></button>');
			 $("#workorderupdate").html('<a class="btn btn-danger btn-sm" id="sl" onclick=" return false;" data-id="<?=$_GET['id'];?>" style="line-height: 29px;color: #fff;margin-right: 5px;font-size: 14px;"><?=t('Delete');?></a><button class="btn btn-primary" onclick="clicked(); return false;"><?=t('Regenerate');?></button>');
	  ...
	  else
	  {
		  ...
		  $("#isperiodform").hide(500);
		   ...
		   <?php if(isset($_GET['id']) && $_GET['id']!='' && !$a)
		  {?>
			 //$("#workorderupdate").html('<a class="btn btn-danger btn-sm" id="sl" onclick="workordersil(this)" data-id="<?=$_GET['id'];?>" style="line-height: 29px;color: #fff;margin-right: 5px;font-size: 14px;"><?=t('Delete');?></a><button class="btn btn-primary" id="kydt" type="submit"><?=t('Save');?></button>');
			 $("#workorderupdate").html('<a class="btn btn-danger btn-sm" id="sl" onclick=" return false;" data-id="<?=$_GET['id'];?>" style="line-height: 29px;color: #fff;margin-right: 5px;font-size: 14px;"><?=t('Delete');?></a><button class="btn btn-primary" id="kydt" type="submit"><?=t('Save');?></button>');
...
<script>
    ...
    $('#workorderspecial_notes').attr('disabled',true);
