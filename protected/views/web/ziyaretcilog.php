...
$ziyaretciLog=ZiyaretciLog::model()->findAll();	?>
        ...
        <div class="card-header">
					<div class="row" style="border-bottom: 1px solid #e3ebf3;">
						<div class="col-xl-9 col-lg-9 col-md-9 mb-1">
					   	<h4 style class="card-title"><?=t('Ziyaretci Log Listesi');?></h4>
						</div>
					</div>
        </div>
        	...
        	<div class="card-body card-dashboard">
              ...
              <tr>
						  	<th><?=t('IP');?></th>
								<th><?=t('SAYFA');?></th>
								<th><?=t('URL');?></th>
                <th><?=t('ZIYARET TARİHİ');?></th>
                <th><?=t('PROCESS');?></th>
             </tr>
            </thead>
            <tbody>
            <?php foreach($ziyaretciLog as $ziyaretciLogx):?>
              <tr>
								<td><?=$ziyaretciLogx->ip;?></td>

								<td><?=$ziyaretciLogx->sayfa;?></td>
                <td><?=$ziyaretciLogx->url;?></td>
								<td><?=$ziyaretciLogx->ziyaret_tarihi;?></td>
							<td>	<a class="btn btn-danger btn-sm" onclick="openmodalsil(this)" data-id="<?=$iletisimX->ziyaretci_log_no;?>"
        ...
        <div class="form-group">
            ...
            <div class="modal fade text-left" id="sil" tabindex="-1" role="dialog" aria-labelledby="myModalLabel8"
                ...
                <div class="modal-dialog" role="document">
					...
					<!--form baslang��-->
						<form id="conformitytype-form" action="/web/ziyaretcilogdelete/0" method="post">

						<input type="hidden" class="form-control" id="modaltypeid2" name="Ziyaretcilog[id]" value="0">
