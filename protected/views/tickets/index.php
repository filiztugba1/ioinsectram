							  ...
							  ?>
  							  <tr>
								  ...
								  <td><?=$userr->name." ".$userr->surname?></td>
  								  ...
  								  <td><?=$ticket->status==2?'<span style="color:white;padding:5px 10px;background-color:#5cb85c;border-radius:10px;">'.t('Closed').' </span>':
								  '<span style="color:white;padding:5px 10px ;background-color:#ffc107;border-radius:10px;">'.t('Opened').'</span>'?></td>
  								  <td>
