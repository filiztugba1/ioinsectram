...
<!-- Sayfada neredeyiz -->
<?=User::model()->geturl('Firm','Client',$_GET['id'],'firm');?>
			...
			<div class="card">
				<div class="card-header" style="">
					<ul class="nav nav-tabs">
						 <?php if($type=="firm"){?>
						   <li class="nav-item">
								<a class="nav-link "  href="<?=Yii::app()->baseUrl;?>/firm/branch?type=<?=$type;?>&&id=<?=$_GET['id'];?>" ><span class="btn-effect2" style="font-size: 15px;"><?php echo count( $firm);?></span><?=t('Branch');?></a></a>
						  </li>
						 <?php }?>

						  <li class="nav-item">
							<a class="nav-link "  href="<?=Yii::app()->baseUrl;?>/firm/staff?type=<?=$type;?>&&id=<?=$_GET['id'];?>" ><span class="btn-effect2" style="font-size: 15px;">
							<?=	count($say);?>
							</span><?=t('Staff');?></a></a>
						  </li>
						...
						<?php if($type=="branch" && $ax->branchid==0){?>
						   <li class="nav-item">
							<a class="nav-link"  href="<?=Yii::app()->baseUrl;?>/firm/staffteam?type=<?=$type;?>&&id=<?=$_GET['id'];?>"><span class="btn-effect2" style="font-size: 15px;"><?php echo count( $staffteams);?></span><?=t('Staffteam');?></a></a>
						  </li>
						 <?php }?>

						  <?php if($type=="branch" && $ax->branchid==0){?>
						   <li class="nav-item">
							<a class="nav-link active"  href="<?=Yii::app()->baseUrl;?>/firm/client?type=<?=$type;?>&&id=<?=$_GET['id'];?>"><span class="btn-effect2" style="font-size: 15px;"><?php echo count($client)+count($tclient);?></span><?=t('Client');?></a></a>
						  </li>
						 <?php }?>
			...
			<div class="card">
					<div class="card-header" style="padding-bottom: 10px;">
						 <div class="row" style="padding-bottom: 10px;border-bottom: 1px solid #f8f8f9;">
							 <div class="col-md-6">
								<h4  class="card-title"><?=t('Client Create');?></h4>
							</div>
							<div class="col-md-6">
					...
					<form id="client-form" action="<?=Yii::app()->baseUrl;?>/client/create" method="post">
						<div class="card-content">
							<div class="card-body">

								<div class="row">
								<input type="hidden" class="form-control" id="basicInput"  name="Client[bfirmid]" value="<?=$_GET['id'];?>">
									...
									<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
										<fieldset class="form-group">
											...
											<input type="text" class="form-control" id="basicInput" placeholder="<?=t('Name');?>" name="Client[name]">
										</fieldset>
									</div>
									<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
										<label for="basicSelect"><?=t('Commercial Title');?></label>
										<fieldset class="form-group">
											<input type="text" class="form-control" id="basicInput" placeholder="<?=t('Title');?>" name="Client[title]">
										</fieldset>
									</div>
									...
									<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
										...
										<fieldset class="form-group">
											<input type="text" class="form-control" id="basicInput" placeholder="<?=t('Taxoffice');?>" name="Client[taxoffice]">
										</fieldset>
									</div>
									<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
										<label for="basicSelect"><?=t('Taxno');?></label>
										<fieldset class="form-group">
											<input type="text" class="form-control" id="basicInput" placeholder="<?=t('Taxno');?>" name="Client[taxno]">
										</fieldset>
								</div>
							...
							<label for="basicSelect"><?=t('Land Phone');?></label>
								<fieldset class="form-group">
								  <input type="text" class="form-control" id="basicInput" placeholder="<?=t('Land Phone');?>" name="Client[landphone]" >
								</fieldset>
							</div>
					...
					<label for="basicSelect"><?=t('Address Line');?> 1</label>
                        <fieldset class="form-group">
						<textarea  type="text" name="Client[address]" class="form-control" placeholder="<?=t('Address Line')?> 1"></textarea>
					...
					<label for="basicSelect"><?=t('Address Line');?> 2</label>
                        <fieldset class="form-group">
						  <textarea  type="text" name="Client[address2]" class="form-control" placeholder="<?=t('Address Line')?> 2"></textarea>
					...
					<label for="basicSelect"><?=t('Address Line');?> 3</label>
                        <fieldset class="form-group">
						<textarea  type="text" name="Client[address3]" class="form-control" placeholder="<?=t('Address Line')?> 3"></textarea>
                        </fieldset>
                    </div>
					-->
	<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
					<label for="basicSelect"><?=t('Town or city');?></label>
                        <fieldset class="form-group">
                          <input type="text" class="form-control" id="basicInput" placeholder="<?=t('Town or city');?>" name="Client[town_or_city]" >
                        </fieldset>
                    </div>
<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
					<label for="basicSelect"><?=t('Post code');?></label>
                        <fieldset class="form-group">
                          <input type="text" class="form-control" id="basicInput" placeholder="<?=t('Post code');?>" name="Client[postcode]" >
                        </fieldset>
                    </div>
							...
							<label for="basicSelect"><?=t('E-mail');?></label>
								<fieldset class="form-group">
								  <input type="email" class="form-control" id="basicInput" placeholder="<?=t('E-mail');?>" name="Client[email]" >
								</fieldset>
							</div>
								...
								<div class="col-xl-12 col-lg-12 col-md-12 mb-1" style='background: #ececec;padding-top: 15px;'>
									<div class="row">
											<div class="col-xl-6 col-lg-6 col-md-6 mb-1">
											<label for="basicSelect"><?=t('Contract start date');?></label>
												<fieldset class="form-group">
												  <input type="date" class="form-control" id="basicInput" value='<?=date('Y-m-d');?>' required name="Client[contractstartdate]" >
												</fieldset>
											</div>

											<?$date = date('Y-m-d', strtotime('-1 day +1 year', time()));?>

											<div class="col-xl-6 col-lg-6 col-md-6 mb-1">
											<label for="basicSelect"><?=t('Contract finish date');?></label>
												<fieldset class="form-group">
												    <input type="date" class="form-control" id="basicInput" value='<?=$date;?>' required name="Client[contractfinishdate]" >
												</fieldset>
											</div>
											...
											<div class="col-xl-6 col-lg-6 col-md-6 mb-1">
												<label for="basicSelect"><?=t('Products Amount');?></label>
												   <fieldset class="form-group">
													  <input type="number" class="form-control" id="basicInput" placeholder="<?=t('Products Amount');?>" name="Client[productsamount]">
													</fieldset>
											</div>

											<div class="col-xl-6 col-lg-6 col-md-6 mb-1">
												<label for="basicSelect"><?=t('KDV');?></label>
												   <fieldset class="form-group">
													  <select class="custom-select block" id="customSelect" name="Client[iskdv]">
														<option value="1" ><?=t('Including');?></option>
														<option value="0" selected><?=t('Excluding');?></option>
													  </select>
													</fieldset>
											</div>
                ...
                <div class="card-header">
					<div class="row" style="border-bottom: 1px solid #e3ebf3;">
					    <div class="col-xl-9 col-lg-9 col-md-9 mb-1">
							<h4 class="card-title"><?=t('CLIENT LIST');?></h4>
						</div>

						<div class="col-xl-3 col-lg-3 col-md-3 mb-1">
								<div class="input-group-append" id="button-addon2" style="float: right; text-align: right;">
									<button class="btn btn-info" id="createbutton" type="submit"><?=t('Add Client');?> <i class="fa fa-plus"></i></button>
								</div>
						</div>
					</div>
   	      <a href='?type=<?=$_GET['type'];?>&id=<?=$_GET['id'];?>&status=2' class="btn btn-danger btn-sm <?=$isActive==2?'isActive':'';?>" style='float:right' type="submit"><?=t('Passive');?> </a>

					<a href='?type=<?=$_GET['type'];?>&id=<?=$_GET['id'];?>&status=1' class="btn btn-success btn-sm <?=$isActive==1?'isActive':'';?>" style='float:right' type="submit"><?=t('Active');?> </a>
					<a href='?type=<?=$_GET['type'];?>&id=<?=$_GET['id'];?>&status=0' class="btn btn-warning btn-sm <?=$isActive==0?'isActive':'';?>" style='float:right'  type="submit"><?=t('All');?> </a>
                ...
                foreach($client as $clients):?>
                                <tr>
                                    <td><a href="<?=Yii::app()->baseUrl;?>/client/detail?id=<?=$clients->id;?>&firmid=<?=$_GET['id'];?>"><?=$clients->name;?></a></td>
									...
									<td>
										<div class="form-group pb-1">
											<input type="checkbox" data-size="sm" id="switchery"  class="switcheryx" data-id="<?=$clients->id;?>"  <?php if($clients->active==1){echo "checked";}?> <?php if (Yii::app()->user->checkAccess('client.update')==0){?>disabled<?php }?>/>
										</div>
									</td>
									...
									<td>
										<a  class="btn btn-warning btn-sm" onclick="openmodal(this)" data-id="<?=$clients->id;?>"
																									  ...
																									  data-startdate='<?=$clients->contractstartdate;?>'
																									  data-finishdate='<?=$clients->contractfinishdate;?>'
																									  data-kdv='<?=$clients->iskdv;?>'
										...
										<a href="<?=Yii::app()->baseUrl?>/site/detail/<?=$clients->id;?>"  class="btn btn-info btn-sm" ><i style="color:#fff;" class="fa fa-info"></i></a>
										<a class="btn btn-danger btn-sm" onclick="openmodalsil(this)" data-id="<?=$clients->id;?>" data-parentid="0"><i style="color:#fff;" class="fa fa-trash"></i></a>
							...
							<?php foreach($tclient as $tclientx){
								$transfer=Client::model()->find(array('condition'=>'id='. $tclientx->id))
								?>
                                <tr>
																		<td><a href="/client/detail?id=<?=$transfer->id;?>&firmid=<?=$_GET['id'];?>"><?=$transfer->name;?></a></td>


										<?php $sector=Sector::model()->find(array(
											'condition'=>'id=:id',
											'params'=>array(':id'=>$transfer->branchid),
										));?>
								...
								<td>
									<div class="form-group pb-1">
										<input type="checkbox" data-size="sm" id="switchery"  class="switchery" data-id="<?=$transfer->id;?>"  <?php if($transfer->active==1){echo "checked";}?> <?php if (Yii::app()->user->checkAccess('client.update')==0){?>disabled<?php }?>/>
									</div>
								</td>

									<td>
									<?php if (Yii::app()->user->checkAccess('client.update')){ ?>
									 <a  class="btn btn-warning btn-sm" onclick="openmodal(this)" data-id="<?=$transfer->id;?>"
																									  data-name="<?=$transfer->name;?>"
																									  data-title="<?=$transfer->title;?>"
																									  data-taxoffice="<?=$transfer->taxoffice;?>"
																									  data-taxno="<?=$transfer->taxno;?>"
																									  data-active="<?=$transfer->active;?>"
																									  data-branchid="<?=$transfer->branchid;?>"
																									  data-parentid="0"
																									  data-email="<?=$transfer->email;?>"
																									  data-landphone="<?=$transfer->landphone;?>"
																									  data-address="<?=$transfer->address;?>"
																									  data-startdate='<?=$transfer->contractstartdate;?>'
																									  data-finishdate='<?=$transfer->contractfinishdate;?>'
																									  data-kdv='<?=$transfer->iskdv;?>'
																									  data-email='<?=$transfer->email;?>'
																									  data-productsamount='<?=$transfer->productsamount;?>'
																									   data-address="<?=$clients->address;?>"
																									  data-address2="<?=$clients->address2;?>"
																									  data-address3="<?=$clients->address3;?>"
																									  data-town_or_city="<?=$clients->town_or_city;?>"
									...
									<?php if (Yii::app()->user->checkAccess('client.branch.view')){ ?>
										 <a href="<?=Yii::app()->baseUrl?>/site/detail/<?=$transfer->id;?>"  class="btn btn-info btn-sm" ><i style="color:#fff;" class="fa fa-info"></i></a>
									<?php }?>
									<?php if (Yii::app()->user->checkAccess('client.delete')){ ?>
									<a class="btn btn-danger btn-sm" onclick="openmodalsil(this)" data-id="<?=$transfer->id;?>" data-parentid="0"><i style="color:#fff;" class="fa fa-trash"></i></a>
									<?php }?>
									</td>
                                </tr>
					...
					<!--form baslangıç-->
						<form id="client-form" action="<?=Yii::app()->baseUrl;?>/client/update/0" method="post">
                            <div class="modal-body">
								...
								<input type="hidden" class="form-control" id="modalparentid" name="Client[parentid]" value="0">
								<input type="hidden" class="form-control" id="basicInput"  name="Client[bfirmid]" value="<?=$_GET['id'];?>">
						...
						<div class="col-xl-12 col-lg-12 col-md-12 mb-1" style='background: #ececec;padding-top: 15px;'>
								<div class="row">
										<div class="col-xl-12 col-lg-12 col-md-12 mb-1">
											<label for="basicSelect"><?=t('Contract start date');?></label>
												<fieldset class="form-group">
												  <input type="date" class="form-control" id="startdate"  required name="Client[contractstartdate]" >
												</fieldset>
											</div>
											...
											<label for="basicSelect"><?=t('Contract finish date');?></label>
												<fieldset class="form-group">
												  <input type="date" class="form-control" id="finishdate"  required name="Client[contractfinishdate]" >
												</fieldset>
											</div>
											...
											<div class="col-xl-12 col-lg-12 col-md-12 mb-1">
												<label for="basicSelect"><?=t('KDV');?></label>
												   <fieldset class="form-group">
													  <select class="custom-select block" id="iskdv" name="Client[iskdv]">
														<option value="1" selected><?=t('Including');?></option>
														<option value="0"><?=t('Excluding');?></option>
													  </select>
													</fieldset>
											</div>
									</div>
...
function openmodalsil(obj)
{
		...
		$.post( "<?=Yii::app()->baseUrl;?>/firm/firmdelete?id="+$(obj).data('id')+'&&user=Client&&type=client').done(function( data ) {
		if(data>0)
		{
