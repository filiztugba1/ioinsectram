				...
				<div class="card-header" style="">
					<ul class="nav nav-tabs">
						...
						<?php if (Yii::app()->user->checkAccess('firm.branch.view')) { ?>
							<?php if ($type == "firm") { ?>
								<li class="nav-item">
									<a class="nav-link active" href="<?= Yii::app()->baseUrl; ?>/firm/branch?type=<?= $type; ?>&&id=<?= $_GET['id']; ?>"><span
											class="btn-effect2" style="font-size: 15px;"><?php echo count($firm); ?></span>
										<?= t('Branch'); ?></a>
								</li>
							<?php }
						} ?>
		...
		<div class="row" id="createpage">
			<div class="col-xl-12 col-lg-12 col-md-12">
				...
				<div class="card">
					...
					<form id="firm-form" action="<?= Yii::app()->baseUrl; ?>/firm/create" method="post">
						<div class="card-content">
							<div class="card-body">

								<input type="hidden" class="form-control" id="basicInput" name="Firm[type]"
									value="<?= $type; ?>">
								...
								<div class="row">
									<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
										...
										<fieldset class="form-group">
											<input type="text" class="form-control" id="basicInput"
												value='<?= $availablefirm->name; ?>' placeholder="<?= t('Name'); ?>"
												name="Firm[name]" requred>
										</fieldset>
									</div>
									...
									<input type="hidden" class="form-control" id="basicInput" name="Firm[parentid]"
										value="<?= $_GET['id'] ?>">
									<input type="hidden" class="form-control" id="basicInput" name="Firm[location]"
										value="branch">
									...
									<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
										...
										<fieldset class="form-group">
											<input type="text" class="form-control" id="basicInput"
												value='<?= $availablefirm->title; ?>'
												placeholder="<?= t('Commercial Title'); ?>" name="Firm[title]">
										</fieldset>
									</div>
									...
									<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
										...
										<fieldset class="form-group">
											<input type="text" class="form-control" id="basicInput"
												placeholder="<?= t('Tax Office'); ?>" value='<?= $availablefirm->taxoffice; ?>'
												name="Firm[taxoffice]">
										</fieldset>
									</div>
									...
									<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
										...
										<fieldset class="form-group">
											<input type="text" class="form-control" id="basicInput"
												placeholder="<?= t('Tax No'); ?>" value='<?= $availablefirm->taxno; ?>'
												name="Firm[taxno]">
										</fieldset>
									</div>
									...
									<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
										...
										<fieldset class="form-group">
											<input type="text" class="form-control" id="basicInput"
												placeholder="<?= t('Land Phone'); ?>" value='<?= $availablefirm->landphone; ?>'
												name="Firm[landphone]">
										</fieldset>
									</div>
									...
									<div class="col-xl-6 col-lg-6 col-md-6 mb-1">
										...
										<fieldset class="form-group">
											<input type="email" class="form-control" id="basicInput"
												placeholder="<?= t('E-mail'); ?>" value='<?= $availablefirm->email; ?>'
												name="Firm[email]">
										</fieldset>
									</div>
									...
									<div class="col-xl-6 col-lg-6 col-md-6 mb-1">
										...
										<fieldset class="form-group">
											<input type="text" class="form-control" id="basicInput"
												placeholder="<?= t('Address'); ?>" value='<?= $availablefirm->address; ?>'
												name="Firm[address]">
										</fieldset>
									</div>
									...
									<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
										...
										<fieldset class="form-group">
											<select class="custom-select block" id="customSelect" name="Firm[country_id]"
												required>
									...
									<div class="col-xl-12 col-lg-12 col-md-12 mb-1">
										<fieldset class="form-group">
											<div class="input-group-append" id="button-addon2" style="float: right;">
												<button class="btn btn-primary block-page"
								...
								<tbody>
									<?php foreach ($firm as $firms): ?>
										<tr>
											<td>
												<a
													href="<?= Yii::app()->baseUrl; ?>/firm/staff?type=branch&&id=<?= $firms->id; ?>"><?= $firms->name; ?></a>
											</td>

											<td>
												<?php echo date('Y-m-d', $firms->createdtime);

												// Generalsettings::model()->dateformat($firms->createdtime); 
												?>
											</td>
											...
											<td>
												<div class="form-group pb-1">
													<input type="checkbox" id="switchery" data-size="sm" class="switchery"
														data-id="<?= $firms->id; ?>" <?php if ($firms->active == 1) {
															  echo "checked";
														  } ?> 			 		<?php if (Yii::app()->user->checkAccess('firm.branch.update') == 0) { ?>disabled<?php } ?> />
												</div>
											</td>
											...
											<td>
												<?php if (Yii::app()->user->checkAccess('firm.branch.update')) { ?>
													<a class="btn btn-warning btn-sm" onclick="openmodal(this)"
														data-id="<?= $firms->id; ?>" data-name="<?= $firms->name; ?>"
														data-active="<?= $firms->active; ?>" data-title="<?= $firms->title; ?>"
						...
						<div class="modal-content">
							<div class="modal-header bg-warning white">
								<h4 class="modal-title" id="myModalLabel8">
									<?= $availablefirm->name . ' ' . t('Branch Update'); ?>
								</h4>
							...
							<!--form baslang��-->
							<form id="firm-form" action="<?= Yii::app()->baseUrl; ?>/firm/update/0" method="post">
								<div class="modal-body">
									<input type="hidden" class="form-control" id="modalfirmid" name="Firm[id]" value="0">
									<div class="col-xl-12 col-lg-12 col-md-12 mb-1">
										<label for="basicSelect"><?= t('Name'); ?></label>
										<fieldset class="form-group">
											<input type="text" class="form-control" id="modalfirmname"
												placeholder="<?= t('Name'); ?>" name="Firm[name]" value="">
										</fieldset>
									</div>
									...
									<div class="col-xl-12 col-lg-12 col-md-12 mb-1">
										<label for="basicSelect"><?= t('Commercial Title'); ?></label>
										<fieldset class="form-group">
											<input type="text" class="form-control" id="modalfirmtitle"
												placeholder="<?= t('Commercial Title'); ?>" name="Firm[title]">
										</fieldset>
									</div>
									...
									<div class="col-xl-12 col-lg-12 col-md-12 mb-1">
										<label for="basicSelect"><?= t('Tax Office'); ?></label>
										<fieldset class="form-group">
											<input type="text" class="form-control" id="modalfirmtaxoffice"
												placeholder="<?= t('Tax Office'); ?>" name="Firm[taxoffice]">
										</fieldset>
									</div>
									...
									<div class="col-xl-12 col-lg-12 col-md-12 mb-1">
										<label for="basicSelect"><?= t('Tax No'); ?></label>
										<fieldset class="form-group">
											<input type="text" class="form-control" id="modalfirmtaxno"
												placeholder="<?= t('Tax No'); ?>" name="Firm[taxno]">
										</fieldset>
									</div>
									...
									<div class="col-xl-12 col-lg-12 col-md-12 mb-1">
										<label for="basicSelect"><?= t('Address'); ?></label>
										<fieldset class="form-group">
											<input type="text" class="form-control" id="modalfirmaddress"
												placeholder="<?= t('Address'); ?>" name="Firm[address]">
										</fieldset>
									</div>
									...
									<div class="col-xl-12 col-lg-12 col-md-12 mb-1">
										<label for="basicSelect"><?= t('Land Phone'); ?></label>
										<fieldset class="form-group">
											<input type="text" class="form-control" id="modalfirmlandphone"
												placeholder="<?= t('Land Phone'); ?>" name="Firm[landphone]">
										</fieldset>
									</div>
									...
									<div class="col-xl-12 col-lg-12 col-md-12 mb-1">
										<label for="basicSelect"><?= t('E-mail'); ?></label>
										<fieldset class="form-group">
											<input type="email" class="form-control" id="modalfirmemail"
												placeholder="<?= t('E-mail'); ?>" name="Firm[email]">
										</fieldset>
									</div>
									...
									<div class="col-xl-12 col-lg-12 col-md-12 mb-1">
										<label for="basicSelect"><?= ucfirst(t('Country')); ?></label>
										<fieldset class="form-group">
											<select class="custom-select block" id="modalcountry_id" name="Firm[country_id]"
												required>
												<? foreach ($countries as $country) { ?>
				...
				<div class="modal fade text-left" id="sil" tabindex="-1" role="dialog" aria-labelledby="myModalLabel8"
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<!--form baslang��-->
							<form id="firm-form" action="<?= Yii::app()->baseUrl; ?>/firm/delete/0" method="post">
...
<script>
	...
	function openmodalsil(obj) {
		...
		$.post("<?= Yii::app()->baseUrl; ?>/firm/firmdelete?id=" + $(obj).data('id') + '&&user=Client&&type=branch').done(function (data) {
			if (data > 0) {
	...
	function authchange(data, permission, obj) {
		$.post("<?= Yii::app()->baseUrl; ?>/firm/authchange", { firmid: data, active: permission })
