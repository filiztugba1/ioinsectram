									...
									<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
										...
										<fieldset class="form-group">
											<input type="text" class="form-control" id="basicInput"
												placeholder="<?= t('Name'); ?>" name="Firm[name]" required>
										</fieldset>
									</div>
										...
										<fieldset class="form-group">
											<select class="custom-select block" id="customSelect" name="Firm[package]" required>
												<? foreach ($packages as $package) { ?>
													<option value="<?= $package->name; ?>" <?= $package->name == 'Standart2023' ? 'selected' : ''; ?>><?= $package->name; ?>
													</option>
												<?php } ?>
											</select>
										</fieldset>
									...
									<div class="col-xl-12 col-lg-12 col-md-12 mb-1">
										<fieldset class="form-group">
											<div class="input-group-append" id="button-addon2">
												<button class="btn btn-primary block-page" id="button"
							...
							<?php if (Yii::app()->user->checkAccess('firm.create')) { ?>
								<div class="col-xl-3 col-lg-3 col-md-3 mb-1">
									<div class="input-group-append" id="button-addon2" style="float: right; text-align: right;">
										<button class="btn btn-info" id="createbutton" type="submit"><?= t('Add Firm'); ?> <i
								...
								<tbody>
									<?php foreach ($firm as $firms): ?>
										<tr>
											...
											<a href="<?=Yii::app()->baseUrl;?>/firm/<?= (isset($type) && $type == 'branch') ? 'staff' : 'branch' ?>?type=firm&id=<?= $firms->id ?>">
												<?= CHtml::encode($firms->name) ?>
											</a>
										<?php endif; ?>
												...
												<div class="form-group pb-1">
													<input type="checkbox" id="switchery" data-size="sm" class="switchery"
														data-id="<?= $firms->id; ?>" <?php if ($firms->active == 1) {
															  echo "checked";
														  } ?> 		<?php if (Yii::app()->user->checkAccess('firm.update') == 0) { ?>disabled<?php } ?> />
												</div>
											</td>
											...
											<td>
												<?php if (Yii::app()->user->checkAccess('firm.update')) { ?>
													<a class="btn btn-warning btn-sm" onclick="openmodal(this)"
														...
														data-email="<?= $firms->email; ?>" data-package="<?= $firms->package; ?>"
