...
<?php if (Yii::app()->user->checkAccess('languages.view')){ ?>
<!-- Sayfada neredeyiz -->
<?=User::model()->geturl('Languages','',0,'languages');?>
<?php if (Yii::app()->user->checkAccess('languages.create')){ ?>
			...
			<div class="card">
			   <div class="card-header">
						 <div class="row" style="padding-bottom: 10px;border-bottom: 1px solid #f8f8f9;">
							 <div class="col-md-6">
								  <h4  class="card-title"><?=t('New Languages Create');?></h4>
									</div>
									 <div class="col-md-6">
				...
				<form id="languages-form" action="/languages/create" method="post">
				<div class="card-content">
					...
					<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
                        <fieldset class="form-group">
                          <input type="text" class="form-control" id="basicInput" placeholder="<?=t('Name');?>" name="Languages[name]">
                        </fieldset>
                    </div>
                      ...
                      <table class="table table-striped table-bordered dataex-html5-export">
                        ...
                        <tbody>
             				<?php foreach($languages as $language):?>
                                <tr>
								<td><input type="checkbox" name="Languages[id][]" class='sec' value="<?=$language->id;?>"></td>
                                    <td><?=t($language->name);?></td>

									<td>
									<?php if (Yii::app()->user->checkAccess('languages.update')){ ?>
										 <a  class="btn btn-warning btn-sm" onclick="openmodal(this)" data-id="<?=$language->id;?>" data-name="<?=$language->name;?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?=t('Update');?>"><i style="color:#fff;" class="fa fa-edit"></i></a>
									<?php }?>
									<?php if (Yii::app()->user->checkAccess('languages.delete')){ ?>
									<a class="btn btn-danger btn-sm" onclick="openmodalsil(this)" data-id="<?=$language->id;?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?=t('Delete');?>"><i style="color:#fff;" class="fa fa-trash"></i></a>
									<?php }?>
									</td>
                                </tr>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header bg-warning white">
                            <h4 class="modal-title" id="myModalLabel8"><?=t('Languages Update');?></h4>
					...
					<!--form baslangıç-->
						<form id="languages-form" action="/languages/update/0" method="post">
                            <div class="modal-body">
								<input type="hidden" class="form-control" id="modallanguagesid" name="Languages[id]" value="0">
								<div class="col-xl-12 col-lg-12 col-md-12 mb-1">
								<label for="basicSelect"><?=t('Name');?></label>
									<fieldset class="form-group">
										<input type="text" class="form-control" id="modallanguagesname" placeholder="<?=t('Name');?>" name="Languages[name]" value="">
									</fieldset>
								</div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header bg-danger white">
                            <h4 class="modal-title" id="myModalLabel8"><?=t('Languages Delete');?></h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
                            </button>
                        </div>
					...
					<!--form baslangıç-->
						<form id="languages-form" action="/languages/delete/0" method="post">

						<input type="hidden" class="form-control" id="modallanguagesid2" name="Languages[id]" value="0">
	...
	<!--delelete all start-->
        ...
        <div class="form-group">
            ...
            <div class="modal fade text-left" id="deleteall" tabindex="-1" role="dialog" aria-labelledby="myModalLabel8"
				...
				<!--form baslangıç-->
						<form action="/languages/deleteall" method="post">

						<input type="hidden" class="form-control" id="modalid3" name="Languages[id]" value="0">
...
{
	$('#modallanguagesid').val($(obj).data('id'));
	$('#modallanguagesname').val($(obj).data('name'));
	$('#duzenle').modal('show');
...
{
	$('#modallanguagesid2').val($(obj).data('id'));
	$('#sil').modal('show');
