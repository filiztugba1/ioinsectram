...
<?	if (Yii::app()->user->checkAccess('email.recipiant.information.view')){?>
             			...
             			<?php foreach($email as $emailx):?>
								...
								<td> 
									<div class="form-group pb-1">
										<input type="checkbox" id="switchery" data-size="sm"  class="switchery" data-id="<?=$emailx->id;?>"  <?if($emailx->isdefault==1){echo "checked";}?> />
									</div>								
								</td>
								...
								<?	if (Yii::app()->user->checkAccess('email.recipiant.information.update')){?>
									...
									<?}?>
									<?	if (Yii::app()->user->checkAccess('email.recipiant.information.delete')){?>
