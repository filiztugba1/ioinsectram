...
User::model()->login();
	...
	<?	if (Yii::app()->user->checkAccess('auth.type.create')){?>
                ...
                <div class="card-content collapse show">
				  ...
				  <div class="treex well">
					...
					<a onclick="opencreate(this)" data-id="0" class="btn btn-primary">NEW TYPE ADD</a>
								...
								<? Authtypes::model()->kategoritabloyaz(0);?>
...
<?	if (Yii::app()->user->checkAccess('auth.type.update')){?>	
<!-- GÜNCELLEME BAÞLANGIÇ-->		
	...
	<!-- GÜNCELLEME BÝTÝÞ-->
<?}?>
<?	if (Yii::app()->user->checkAccess('auth.type.delete')){?>	
	<!--SÝL BAÞLANGIÇ-->
