...
/**
 * This is the model class for table "departmentvisitedti".
 *
 * The followings are the available columns in table 'departmentvisitedti':
 * @property integer $id
 ...
 */
class Departmentvisitedti extends CActiveRecord
{
	/**
	 ...
	 * @return Departmentvisitedti the static model class
	 */
