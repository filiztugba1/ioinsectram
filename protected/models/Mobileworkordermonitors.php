...
/**
 * This is the model class for table "mobileworkordermonitors".
 *
 * The followings are the available columns in table 'mobileworkordermonitors':
 * @property integer $id
 ...
 */
class Mobileworkordermonitors extends CActiveRecord
{
	/**
	...
	{
		return 'mobileworkordermonitors';
	}
	 ...
	 * @return Mobileworkordermonitors the static model class
	 */
