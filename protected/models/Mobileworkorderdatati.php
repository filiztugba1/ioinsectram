...
/**
 * This is the model class for table "mobileworkorderdatati".
 *
 * The followings are the available columns in table 'mobileworkorderdatati':
 * @property integer $id
 ...
 */
class Mobileworkorderdatati extends CActiveRecord
{
	/**
	 ...
	 * @return Mobileworkorderdatati the static model class
	 */
