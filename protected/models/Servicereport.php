 ...
 * @property string $treatment_and_observations
 * @property string $housekeeping
 * @property string $proofing
 * @property string $visit_report_summary
 */
class Servicereport extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'treatment_and_observations' => 'treatment_and_observations',
			'housekeeping' => 'housekeeping ',
			'proofing' => 'proofing',
			'visit_report_summary' => 'visit_report_summary',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('treatment_and_observations',$this->treatment_and_observations,true);
		$criteria->compare('housekeeping',$this->housekeeping,true);
		$criteria->compare('proofing',$this->proofing,true);
		$criteria->compare('visit_report_summary',$this->visit_report_summary,true);
