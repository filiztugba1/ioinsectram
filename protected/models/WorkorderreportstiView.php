...
/**
 * This is the model class for table "workorderreports_view".
 *
 * The followings are the available columns in table 'workorderreports_view':
 ...
 */
class WorkorderreportstiView extends CActiveRecord
{
	/**
	...
	{
		return 'workorderreportsti_view';
	}
	...
	public function rules()
	{
		...
		return array(
			array('workorderid, monitorid, monitorno, monitortype, barcodeno, barcodestatus, firmid, firmbranchid, clientid, clientbranchid, mwmsaverid, checkdate, pettype', 'required'),
			array('workorderid, monitorid, monitorno, monitortype, barcodestatus, firmid, firmbranchid, clientid, clientbranchid, departmentid, subdepartment, mwmsaverid, checkdate, value, mwdsaverid, openedtimestart, openedtimeend, petid, isproduct', 'numerical', 'integerOnly'=>true),
			array('barcodeno, firmname, firmbranchname, clientname, clientbranchname, departmentname, subdepartmentname, pettype, name, detailed,definationlocation', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('workorderid, monitorid, monitorno, monitortype, barcodeno, barcodestatus, firmid, firmname, firmbranchid, firmbranchname, clientid, clientname, clientbranchid, clientbranchname, departmentid, departmentname, subdepartment, subdepartmentname, mwmsaverid, checkdate, value, mwdsaverid, openedtimestart, openedtimeend, petid, pettype, isproduct, name, detailed', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('pettype',$this->pettype,true);
	 ...
	 * @return WorkorderreportsView the static model class
	 */
