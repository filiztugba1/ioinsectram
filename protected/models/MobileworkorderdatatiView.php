...
/**
 * This is the model class for table "mobileworkorderdata_view".
 *
 * The followings are the available columns in table 'mobileworkorderdata_view':
 * @property integer $id
 ...
 */
class MobileworkorderdatatiView extends CActiveRecord
{
	/**
	...
	{
		return 'mobileworkorderdatati_view';
	}
	...
	public function rules()
	{
		...
		return array(
			array('mobileworkordermonitorsid, workorderid, monitorid, monitortype, petid, pettype, value, saverid, createdtime, firmid, firmbranchid, clientid, clientbranchid, openedtimestart, openedtimeend, isproduct', 'required'),
			array('id, mobileworkordermonitorsid, workorderid, monitorid, monitortype, petid, pettype, value, saverid, createdtime, firmid, firmbranchid, clientid, clientbranchid, departmentid, subdepartmentid, openedtimestart, openedtimeend, isproduct', 'numerical', 'integerOnly'=>true),
			array('departmentname, subdepartmentname', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, mobileworkordermonitorsid, workorderid, monitorid, monitortype, petid, pettype, value, saverid, createdtime, firmid, firmbranchid, clientid, clientbranchid, departmentid, departmentname, subdepartmentid, subdepartmentname, openedtimestart, openedtimeend, isproduct', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return MobileworkorderdataView the static model class
	 */
