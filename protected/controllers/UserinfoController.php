...
class UserinfoController extends Controller
{
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Userinfo']))
		{
			...
			*/
			Yii::app()->SetFlashes->add($model,t(' Success!'),array('index','id'=>$model->id));
  ...
  $usersinfo=Userinfo::model()->find(array(
					  ...
					  $education=Education::model()->find(array(
						#'select'=>'title',
						 ...
						 $languages=Languages::model()->find(array(
							'condition'=>'id=:id',
							'params'=>array(':id'=>$usersinfo->speaks),
						));	
						$certificate=Certificate::model()->find(array(
							'condition'=>'id=:id',
