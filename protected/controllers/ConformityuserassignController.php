	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','reports','print','printimg',"excel",'control'),
				'users'=>array('*'),
			),
	...
	public function actionControl()
	{
		...
		if($ax->type==26)
								...
								//	$userlar.push($userssx->id);
									...
									$conformityuserassign=Conformityuserassign::model()->findAll(array("condition"=>"recipientuserid=".$userssx->id." and returnstatustype=1 and sendtime<=".$startdate,"order"=>"id desc"));
