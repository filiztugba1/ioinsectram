...
// Eğer language=delete gelirse cookie silinir
if (isset($_GET['language']) && $_GET['language'] === 'delete') {
    // Tarayıcıdan sil
    setcookie($cookie_name, '', time() - 3600, "/");

    // PHP belleğinden de sil
    unset($_COOKIE[$cookie_name]);

    // URL'deki language parametresini kaldır
    $actual_link = preg_replace('/[&?]language=delete/', '', $actual_link);
