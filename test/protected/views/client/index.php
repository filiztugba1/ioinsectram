...
<!--
					...
					<label for="basicSelect"><?=t('Address');?></label>
                        <fieldset class="form-group">
                          <input type="text" class="form-control" id="basicInput" placeholder="<?=t('Address');?>" name="Client[address]" >
                        </fieldset>
                    </div>
             			...
             			<?php foreach($client as $clients):?>
								...
								<td>
									<div class="form-group pb-1">
										<input type="checkbox" data-size="sm" id="switchery" <?php if( $transferclient==1){echo 'disabled';}?>  class="switchery" data-id="<?=$clients->id;?>"  <?php if($clients->active==1){echo "checked";}?> <?php if (Yii::app()->user->checkAccess('client.update')==0){?>disabled<?php }?>/>
									</div>
								</td>
