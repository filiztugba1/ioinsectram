...
foreach ($monitors as $monitor) {
  ...
  if($monitor->firmid==412)
  {
      $bolum=$bolum.' - '.$monitor->definationlocation;
        ...
        ';
        $reports = MobileworkorderdataView::model()->findAll(array('select'=>'value,createdtime','condition' => 'isproduct=0  and mobileworkordermonitorsid=' . $monitor->id, 'order' => 'FIELD(petid,26,27,28,29,30,31,32,33,25)'));
