...
$yaz2 .="
<tr>
 <td colspan='6'><img src='".$rmImage."'/></td>
 <td colspan='6'><img src='".$ltImage."'/></td>
</tr>";
$yaz2 .="

<tr>
 <td colspan='6'><img src='".$mtImage."'/></td>
 <td colspan='6'><img src='".$clImage."'/></td>
</tr>";
$yaz2 .="
<tr>
 <td colspan='12'><img src='".$lftImage."'/></td>
</tr>";
            ...
            <tr>
              ...
              <img src='".Yii::app()->getbaseUrl(true)."/".$resim."' width='95px'  >
          		...
          		<td colspan='10' align='center'>
          			<b><h2> Aktivite Rapor Grafik</h2></b>
              ...
              <tr>
                    ...
                    <th colspan='2'>".t('CI-YÜRÜYEN HAŞERE')."</th>
