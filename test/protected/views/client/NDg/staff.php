            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
					...
					<a href='?type=branch&&id=<?=$_GET['id'];?>&&status=2' class="btn btn-danger btn-sm" style='float:right' type="submit"><?=t('Passive');?> </a>

					<a href='?type=branch&&id=<?=$_GET['id'];?>&&status=1' class="btn btn-success btn-sm" style='float:right' type="submit"><?=t('Active');?> </a>
					<a href='?type=branch&&id=<?=$_GET['id'];?>&&status=0' class="btn btn-warning btn-sm" style='float:right'  type="submit"><?=t('All');?> </a>
                </div>
