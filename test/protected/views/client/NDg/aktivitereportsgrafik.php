...
for($i=0;$i<count($baslangisvebitisarray);$i++)
{
    ...
    $rmval=0;
      $rmMd=MobileworkorderdataView::model()->findAll(array("condition"=>"clientbranchid=".$_POST['Report']['clientid']." and monitortype=10 and (petid=37 or petid=38) and createdtime!=0 and createdtime>=".$starttime." and isproduct=0 and createdtime<=".$finishtime.$where));
    foreach($rmMd as $rmMdx)
    {
      $rmval=$rmval+$rmMdx->value;
    }
    $ltMd=MobileworkorderdataView::model()->findAll(array("condition"=>"clientbranchid=".$_POST['Report']['clientid']." and monitortype=8 and (petid=37 or petid=38) and createdtime!=0 and createdtime>".$starttime." and isproduct=0 and createdtime<=".$finishtime.$where));
    $ltval=0;
    foreach($ltMd as $ltMdx)
    {
      $ltval=$ltval+$ltMdx->value;
    }
    $mtMd=MobileworkorderdataView::model()->findAll(array("condition"=>"clientbranchid=".$_POST['Report']['clientid']." and monitortype=9 and createdtime!=0 and createdtime>".$starttime." and isproduct=0 and createdtime<=".$finishtime.$where));
    $mtval=0;
    foreach($mtMd as $mtMdx)
    {
      $mtval=$mtval+$mtMdx->value;
    }
    $clMd=MobileworkorderdataView::model()->findAll(array("condition"=>"clientbranchid=".$_POST['Report']['clientid']." and monitortype=6 and petid!=25 and createdtime!=0 and createdtime>".$starttime." and isproduct=0 and createdtime<=".$finishtime.$where));
    $clval=0;
    foreach($clMd as $clMdx)
    {
      $clval=$clval+$clMdx->value;
    }
    $lftMd=MobileworkorderdataView::model()->findAll(array("condition"=>"clientbranchid=".$_POST['Report']['clientid']." and monitortype=12 and createdtime!=0 and createdtime>".$starttime." and isproduct=0 and createdtime<=".$finishtime.$where));
    $lftval=0;
        ...
        <div class="card-content collapse show">
          ...
          <div class="card-body card-dashboard">
          	...
          	<fieldset class="form-group">
							<label for="basicSelect">Pdf için açıklama giriniz</label>
              <textarea id="description" type="text" class="form-control" placeholder="Pdf için açıklama giriniz" value=""></textarea>
            </fieldset>
          </div>
              ...
              <div class="card">
                ...
                <div class="card-content collapse show">
                  ...
                  <!--  <h6 class='grafikBaslik'><?=trim(t('RM-DIŞ ALAN KEMİRGEN'));?></h6> -->
                    <div id="column-chart-rm" style="width:100%; height:400px;"></div>
              ...
              <div class="card">
                ...
                <div class="card-content collapse show">
                  ...
                  <!--  <h6 class='grafikBaslik'><?=trim(t('LT İÇ ALAN KEMİRGEN'));?></h6> -->
                    <div id="column-chart-lt" style="width:100%; height:400px;"></div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card">
                ...
                <div class="card-content collapse show">
                  ...
                  <!--  <h6 class='grafikBaslik'><?=trim(t('MT-DEPOLANMIŞ ÜRÜN ZARARLISI'));?></h6> -->
                    <div id="column-chart-mt" style="width:100%; height:400px;"></div>
                  </div>
                </div>
              </div>
            </div>
<!--cl--->
            <div class="col-6">
              <div class="card">
                ...
                <div id="column-chart-cl" style="width:100%; height:400px;"></div>
            ...
            <div class="col-6">
              <div class="card">
                ...
                <div class="card-content collapse show">
                  ...
                  <div id="column-chart-lft" style="width:100%; height:400px;"></div>
                  </div>
                </div>
              </div>
            </div>
