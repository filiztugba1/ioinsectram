...
<div class="card">
	<div class="card-header" style="">
		...
		<?php if (Yii::app()->user->checkAccess('client.branch.monitoringpoints.location.view')){ ?>
			<div class="col-xl-6 col-lg-6 col-md-12">
				<form id="auth-item-form" action="/monitoring/monitoringlocationcreate" method="post">
					<div class="card">
						<div class="card-header">
							<h4 class="card-title">Monitoring Point Location Add<a href="/monitoringlocation"><span style="text-align:right;float: right;text-decoration: underline;">See All</span></a></h4>
						</div>
						<div class="card-content">
							<div class="card-body">
								...
								<fieldset>
									...
									<input maxlength="64" placeholder="Location name" class="form-control" name="Monitoringlocation[name]" id="AuthItem_name" type="text" />
									<input  type="hidden" name="Monitoringlocation[active]" value="1" />
									<input  type="hidden" name="Monitoringlocation[branchid]" value="<?=$_GET['id']?>" />
	...
	<?php if (Yii::app()->user->checkAccess('client.branch.monitoringpoints.type.view')){ ?>
			...
			<div class="col-xl-6 col-lg-6 col-md-12">
				<form id="auth-item-form" action="/monitoring/monitoringtypecreate" method="post">
					<div class="card">
						<div class="card-header">
							<h4 class="card-title">Monitoring Point Type Add <a href="/monitoringtype"><span style="text-align:right;float: right;text-decoration: underline;">See All</span></a></h4>
						...
						<div class="card-content">
							<div class="card-body">
								...
								<fieldset>
									<div class="input-group">
									<input maxlength="64" placeholder="Type name" class="form-control" name="Monitoringtype[name]" id="AuthItem_name" type="text" />
									<input  type="hidden" name="Monitoringtype[active]" value="1" />
									<input  type="hidden" name="Monitoringtype[branchid]" value="<?=$_GET['id']?>" />
									<div class="input-group-append" id="button-addon2">
											<button class="btn btn-primary" type="submit">Create</button>
										</div>
									</div>
				...
				<div class="card-content">
					...
					<label for="basicSelect"><?=t('Monitoring Point No');?></label>
                        <fieldset class="form-group" id='monitorno'>
                          <input type="number"  class="form-control"  value="<?=($monitorcount->mno)+1;?>" placeholder="<?=t('Monitoring Point No');?>" name="Monitoring[mno]">
                        </fieldset>
                    </div>
							...
							<?php    $monitoringlocations=Monitoringlocation::model()->findAll();?>
                     ...
                     <fieldset class="form-group">
						  ...
						  <option value="<?=$monitoringlocation->id;?>"><?=$monitoringlocation->name;?></option>
						  <?php }?>
                           </select>
                        </fieldset>
	...
	<div class="col-xl-12 col-lg-12 col-md-12">
			...
			<div class="card">
			   ...
			   <div class="card-header">
				...
				<form id="monitoring-form5" action="/client/showbarcodes" method="post" target="_blank">
				<div class="card-content">
					<div class="card-body">
                ...
                <div class="card-header">
					...
					<div class="row">
						...
						<div class="col-xl-6 col-lg-6 col-md-6 mb-1">
							<a id="all" href="/client/monitoringpoints?id=<?=$_GET['id'];?>" class="btn btn-info"><?=t('All Monitors');?></a>
							<a id="active" href="/client/monitoringpoints?id=<?=$_GET['id'];?>&&isactive=1" class="btn btn-success"><?=t('Active Monitors');?></a>
							<a id="passive" href="/client/monitoringpoints?id=<?=$_GET['id'];?>&&isactive=0" class="btn btn-danger"><?=t('Passive Monitors');?></a>
						</div>
        ...
        <div class="form-group">
            ...
            <div class="modal fade text-left" id="duzenle" tabindex="-1" role="dialog" aria-labelledby="myModalLabel8"
                ...
                <div class="modal-dialog" role="document">
					...
					<!--form baslang��-->
							<form id="departments-form" action="/monitoring/update/0" method="post">
				<div class="card-content">
					<div class="card-body">
					...
					<label for="basicSelect"><?=t('Monitoring Point No');?></label>
                        <fieldset class="form-group">
                          <input type="text" class="form-control" id="modalmonitormno" placeholder="<?=t('Monitoring Point No');?>" name="Monitoring[mno]">
                        </fieldset>
                    </div>
                     ...
                     <fieldset class="form-group">
						...
						<label for="basicSelect"><?=t('Monitoring Point Type');?></label>
                     <fieldset class="form-group">
                          <select class="custom-select block" id="modalmonitormtypeid" name="Monitoring[mtypeid]" >
						  <?php foreach($monitoringtypes as $monitoringtype){?>
						  <option value="<?=$monitoringtype->id;?>"><?=$monitoringtype->name;?></option>
						  <?php }?>
                           </select>
        ...
        <div class="form-group">
            ...
            <div class="modal fade text-left" id="sil" tabindex="-1" role="dialog" aria-labelledby="myModalLabel8"
                ...
                <div class="modal-dialog" role="document">
					...
					<!--form baslang��-->
						<form id="departments-form" action="/monitoring/delete/0" method="post">
						<input type="hidden" class="form-control" id="basicInput"  name="Monitoring[clientid]" value="<?=$_GET['id'];?>">
	...
	<!--delelete all start-->
        ...
        <div class="form-group">
            ...
            <div class="modal fade text-left" id="deleteall" tabindex="-1" role="dialog" aria-labelledby="myModalLabel8"
				...
				<!--form baslang��-->
						<form action="/monitoring/deleteall" method="post">
