        ...
        <div class="card-header" style="">
            <ul class="nav nav-tabs">
                ...
                <?php if (Yii::app()->user->checkAccess('client.branch.reports.view')){ ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link active"  href="<?=Yii::app()->baseUrl?>/client/workorderreports?id=<?=$_GET['id'];?>&firmid=<?=$ax->branchid;?>" ><span class="btn-effect" style="font-size: 15px;"><i class="fa fa-bar-chart-o" style="font-size: 15px;"></i></span><?=t('Workorder Reports');?></a></a>
                    </li>
                <?php }?>
            </ul>
        </div>
