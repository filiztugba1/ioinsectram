...
{
  $pets= $pets .'<td align="center">'.$monitortypeandpetsViewx->name.'</td>';
}
...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td colspan="11" align="center">
            <b><h2>Depolanmış Ürün Zararlıları Üniteleri Kontrol ve İçerik Listesi</h2></b>
            <br><h3>(Güve ve Bitler)<br>(Stored Product Insects Control/Contents Checklist (Moths&amp;Beetles))</h3>
        </td>
    </tr>
    <tr>
        <td colspan="13">Müşteri Adı (Client Name): <b> '.$client->name.'</b></td>
    </tr>
    <tr>
        <td colspan="13">Rapor Kriterleri: '.t($monitype->name)." ".t($monitype->detailed).' <br> '.$kriterler.'</td>
    </tr>
    <tr>
        <td colspan="13">Tarih (Date): '.$_POST['Monitoring']['date'].' / '.$_POST['Monitoring']['date1'].'</td>
    </tr>
    <tr>
        <td colspan="13">Kontrol Eden (Kontroller) - İmza (Signature):</td>
    </tr>

    <tr>
        <td align="center">No</td>
        <td align="center">Cihazın Bulunduğu Yer<br>(Location)</td>
