...
foreach ($monitors as $monitor)
{
  ...
  $veriler= $veriler .'<tr>
    ...
    <td align="left" colspan="2">'.t($bolum).'</td>';
...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td colspan="4">Type of Monitor</td>
    </tr>
    ...
    <tr>
        <td>MT</td>
        <td colspan="3">Güve Tuzağı (Moth Trap)</td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="2">I: Böcek (Insect)</td>
        <td colspan="2">D: Diğer (Other)</td>
    </tr>
    <tr>
        <td>B</td>
