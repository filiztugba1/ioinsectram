...
foreach ($departments as $department) {
  ...
  $parent= Yii::app()->db->createCommand('SELECT *,sum(value) as total FROM mobileworkorderdata where '.$parentsql.'='.$department->id.' and clientbranchid='.$_POST['Report']['clientid'].' and monitortype='.$_POST['Monitoring']['mtypeid'].' and isproduct=0 and (createdtime between '.$midnight.' and '.$midnight2.') '.$sqlnew)->queryAll();
