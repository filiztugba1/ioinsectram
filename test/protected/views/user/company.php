									...
									<div class="card">
										<div class="text-center">
											<div class="card-body">
												...
												<img src="<?php if($firm->image!=''){?><?=Yii::app()->baseUrl.'/'.$firm->image;?><?php }else{?><?=Yii::app()->theme->baseUrl.'/app-assets/images/staff-logo-mrs.png';?><?php }?>" style="width: 100%;"  alt="Company image">
												</div>
											</div>
