...
<!-- Sayfada neredeyiz -->
<?=User::model()->geturl('Stok kimyasal kullanim','',0,'stokkimyasalkullanim/index2');?>
...
<div class="row" id="createpage" >
	<div class="col-xl-12 col-lg-12 col-md-12">
			...
			<div class="card">
				    <div class="card-header">
						 <div class="row" style="padding-bottom: 10px;border-bottom: 1px solid #f8f8f9;">
							 <div class="col-md-6">
								  <h4  class="card-title">Stok kimyasal kullanim</h4>
									</div>
									 <div class="col-md-6">
              ...
              <fieldset class="form-group">
                <input type="text" class="form-control" id="basicInput" placeholder="Kimyasal Adı" name="Stokkimyasalkullanim[kimyasaladi]" requred>
              </fieldset>
          </div>
          <div class="col-xl-4 col-lg-4 col-md-4 mb-1">
              <label for="basicSelect">Aktif Madde Tanımı</label>
              <fieldset class="form-group">
                  <input type="text" class="form-control" id="basicInput" placeholder="Kimyasal Adı" name="Stokkimyasalkullanim[aktifmaddetanimi]" >
              </fieldset>
          </div>
          <div class="col-xl-4 col-lg-4 col-md-4 mb-1">
              <label for="basicSelect">Yöntem</label>
              <fieldset class="form-group">
                  <input type="text" class="form-control" id="basicInput" placeholder="Yöntem" name="Stokkimyasalkullanim[yontem]" >
              </fieldset>
          </div>
          <div class="col-xl-4 col-lg-4 col-md-4 mb-1">
              <label for="basicSelect">Ruhsat Tarihi</label>
              <fieldset class="form-group">
                  <input type="date" class="form-control" id="basicInput" placeholder="Ruhsat Tarihi" name="Stokkimyasalkullanim[ruhsattarih]" >
              </fieldset>
          </div>
          ...
          <div class="col-xl-4 col-lg-4 col-md-4 mb-1">
              ...
              <fieldset class="form-group">
                  <input type="text" class="form-control" id="basicInput" placeholder="Ruhsat No" name="Stokkimyasalkullanim[ruhsatno]" >
              </fieldset>
          </div>
          <div class="col-xl-4 col-lg-4 col-md-4 mb-1">
              ...
              <table class="table table-striped table-bordered dataex-html5-export">
                ...
                <tr>
                  <td><a href="<?=Yii::app()->baseUrl;?>/stokkimyasalkullanim/view/<?=$stokkimyasalkullanim->id;?>"><?=$stokkimyasalkullanim->kimyasaladi;?></a></td>
								...
								<?php if($ax->firmid==0){?>
								<td><?=Firm::model()->find(array('condition'=>'id='.$stokkimyasalkullanim->firmid))->name;?></td>
								<?php }?>

								<?php if($ax->branchid==0){?>
								<td><?=Firm::model()->find(array('condition'=>'id='.$stokkimyasalkullanim->branchid))->name;?></td>
								<?php }?>
        ...
        <div class="form-group">
          ...
          <div class="card-content">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 mb-1">
                <label for="basicSelect">Kimyasal Adı</label>
                <fieldset class="form-group">
                  <input type="text" class="form-control" id="modalkimyasaladi" placeholder="Kimyasal Adı" name="Stokkimyasalkullanim[kimyasaladi]" requred>
                </fieldset>
            </div>
          <div class="col-xl-12 col-lg-12 col-md-12 mb-1">
                <label for="basicSelect">Aktif Madde Tanımı</label>
                <fieldset class="form-group">
                    <input type="text" class="form-control" id="modaltaktifmaddetanimi" placeholder="Aktif Madde Kullanımı" name="Stokkimyasalkullanim[aktifmaddetanimi]" >
                </fieldset>
            </div>
            <div class="col-xl-12 col-lg-12 col-md-12 mb-1">
                <label for="basicSelect">Yöntem</label>
                <fieldset class="form-group">
                    <input type="text" class="form-control" id="modalyontem" placeholder="Yöntem" name="Stokkimyasalkullanim[yontem]" >
                </fieldset>
            </div>
          <div class="col-xl-12 col-lg-12 col-md-12 mb-1">
                <label for="basicSelect">Ruhsat Tarihi</label>
                <fieldset class="form-group">
                    <input type="date" class="form-control" id="modalruhsattarih" placeholder="Ruhsat Tarihi" name="Stokkimyasalkullanim[ruhsattarih]" >
                </fieldset>
            </div>
          ...
          <div class="col-xl-12 col-lg-12 col-md-12 mb-1">
                <label for="basicSelect">Ruhsat No</label>
                <fieldset class="form-group">
                    <input type="text" class="form-control" id="modalruhsatno" placeholder="Ruhsat No" name="Stokkimyasalkullanim[ruhsatno]" >
                </fieldset>
            </div>
          <div class="col-xl-12 col-lg-12 col-md-12 mb-1">
              <label for="basicSelect" class="hidden-xs hidden-sm" style="margin:11px"></label>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header bg-danger white">
                            <h4 class="modal-title" id="myModalLabel8">Stok Kimyasal Silme</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
                            </button>
                        </div>
