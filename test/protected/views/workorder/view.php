				...
				<div class="card-content">
					<div class="card-body">
									...
									<fieldset class="form-group">
										<div class="form-group">
											<div class="input-group">
												<input type="text" class="form-control singledate" id="workorderdate" name="Workorder[date]" <?php if( $workorder->isperiod==1) {echo 'disabled';}?> value="<?php if(isset($_GET['date']) && $_GET['date']!=""){echo $data;}else{echo $data;}?>" required>
									...
									<fieldset class="form-group">
										<div class="form-group">
											<div class="input-group date" id="datetimepicker4" >
												<input type="text" autocomplete="off" <?php if( $workorder->isperiod==1) {echo 'disabled';}?> class="form-control" id="workorderstime" name="Workorder[start_time]" value="<?=$workorder->start_time;?>" required>
												<div class="input-group-append">
													<span class="input-group-text">
									...
									<fieldset class="form-group">
										<div class="form-group">
											<div class="input-group date" id="datetimepicker3" >
												<input type="text" <?php if( $workorder->isperiod==1) {echo 'disabled';}?> class="form-control" id="workorderftime" name="Workorder[finish_time]"  autocomplete="off" value="<?=$workorder->finish_time;?>" >
												<div class="input-group-append">
													<span class="input-group-text">
														<span class="ft-clock"></span>
													</span>
						...
						<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
							...
							<fieldset class="form-group">
								<select class="select2" <?php if( $workorder->isperiod==1) {echo 'disabled';}?>  style="width:100%" id="firm" name="Workorder[firmid]" onchange="myfirm()" required>
						...
						<label for="basicSelect"><?=t('Branch');?></label>
							<fieldset class="form-group">
								<select class="select2" style="width:100%" <?php if( $workorder->isperiod==1) {echo 'disabled';}?> id="branch" name="Workorder[branchid]" onchange="mybranch()"  required placeholder="Please Select">
									<option  value="" hidden><?=t('Please Chose');?></option>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
						<label for="basicSelect"><?=t('Visit Type');?></label>
							<fieldset class="form-group">
							  ...
							  <select class="select2" style="width:100%" id="visittype"  disabled name="Workorder[visittypeid]" <?php if( $workorder->isperiod==1) {echo 'disabled';}?> >
										<option  value="" hidden><?=t('Please Chose');?></option>
										<?php										if($workorder->branchid!=0){
...
?>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 mb-1">
								...
								<fieldset class="form-group">
									<select class="select2" style="width:100%" id="monitoringavailable" <?php if(!$dvisit && !isset($_GET['id'])){echo 'disabled';}?>   onchange="mymonitoring()" name="Workorder[mavailable]">
										<option value="0" <?php if(isset($_GET['id'])){if($dvisit){echo "selected";}}?>><?=t('Not Available');?></option>

										<option value="1" <?php if(isset($_GET['id'])){if(!$dvisit){echo "selected";}}?>><?=t('Available');?></option>
...
?>
			<a class="btn btn-primary" target="_blank" href="<?=Yii::app()->getBaseUrl();?>/site/servicereport?id=<?=$a->id ?>"><?=t('Open Service Report');?></a>
	<?php
}}
    if(isset($_GET['id']) && $_GET['id']!=""){
            ...
            <div class="modal fade text-left" id="workordersil" tabindex="-1" role="dialog" aria-labelledby="myModalLabel8"
                ...
                <div class="modal-dialog" role="document">
					...
					<!--form baslangıç-->
						...
						<form id="user-form" action="/workorder/deleteperiyodik/0" method="post">
