<?php
$id=$_GET["id"];
$mobileworkorderdatas=Mobileworkorderdata::model()->find(array("condition"=>"mobileworkordermonitorsid=".$id));
$workorder=Workorder::model()->findByPk($mobileworkorderdatas->workorderid);
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            ...
                            <table class="table table-striped table-bordered dataex-html5-export">
                                ...
                                <?php
                                $id=$_GET["id"];
                                $mobileworkorderdatas=Mobileworkorderdata::model()->findAll(array("condition"=>"mobileworkordermonitorsid=".$id));

                                foreach($mobileworkorderdatas as $mobileworkorderdata):
                                    $pets=Pets::model()->findByPk($mobileworkorderdata->petid);
                                    ?>
                                    <tr>
                                        <td><?=$pets->name;?></td>
                                        <td><?=$mobileworkorderdata->value;?></td>
                                        <td class="gizl">
                                            <a id="gnc"  class="btn btn-warning btn-sm" onclick="openmodal(this)" data-id="<?=$mobileworkorderdata->id;?>" data-name="<?=$mobileworkorderdata->value;?>" data-pet="<?=$pets->name;?>" data-type="<?=$mobileworkorderdata->pettype;?>" ><i style="color:#fff;" class="fa fa-edit"></i></a>

                                            <a id="sil" class="btn btn-danger btn-sm" onclick="openmodalsil(this)" data-id="<?=$mobileworkorderdata->id;?>"><i style="color:#fff;" class="fa fa-trash"></i></a>
            ...
            <div class="modal fade text-left" id="duzenle" tabindex="-1" role="dialog" aria-labelledby="myModalLabel8"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <!--form baslang��-->
                        <form id="mobileworkorderdata-form" action="/mobile/updatedata/0" method="post">
                            <div class="modal-body">
                                <input type="hidden" class="form-control" id="modalmobileworkorderdataid" name="mobileworkorderdata[id]" value="0">
                                <div class="col-xl-12 col-lg-12 col-md-12 mb-1">
                                    <label for="basicSelect" id="modalmobileworkorderdatapet"></label>
                                    <fieldset class="form-group">
                                        <input type="text" class="form-control" id="modalmobileworkorderdatavalue" placeholder="<?=t('Value');?>" name="mobileworkorderdata[value]" value="">
                                    </fieldset>
                                </div>
            ...
            <div class="modal fade text-left" id="sil" tabindex="-1" role="dialog" aria-labelledby="myModalLabel8"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <!--form baslang��-->
                        <form id="pets-form" action="/mobile/deletedata/0" method="post">
                            <input type="hidden" class="form-control" id="modalmobileworkorderdataids" name="mobileworkorderdata[id]" value="0">
