				...
				<div class="card-content">
					...
					<?php if($ax->firmid==0){?>
						...
						<label for="basicSelect"><?=t('Branch');?></label>
							<fieldset class="form-group">
								<select class="select2" style="width:100%" id="branch" name="Workorder[branchid]"  disabled requred>
									<option value="0"><?=t('Please Chose');?></option>
...
$urlx="/workorder/workorderlist";
 if (isset($_GET) &&(isset($_GET['f']) || isset($_GET['b']))) {
		$urlx="/workorder/workorderlist?f=".$_GET['f']."&b=".$_GET['b']."&t=".$_GET['t']."&s=".$_GET['s'];
}?>
...
$("#search").click(function(){
 ...
 //workorderList("/workorder/workorderlist?f="+f+"&b="+b+"&t="+t+"&s="+Secilenler);
	window.location="/workorder?f="+f+"&b="+b+"&t="+t+"&s="+Secilenler;
