					...
					<ul class="nav nav-tabs">
						...
						<?php if($type=="branch" && $ax->branchid==0){?>
						 ...
						 <?php }?>
						  ...
						  <?php if($type=="branch" && $ax->branchid==0){?>
						   <li class="nav-item">
							<a class="nav-link active"  href="/firm/client?type=<?=$type;?>&&id=<?=$_GET['id'];?>"><span class="btn-effect2" style="font-size: 15px;"><?php echo count( $client)+count( $tclient);?></span><?=t('Client');?></a></a>
						  </li>
						 <?php }?>
							...
							<label for="basicSelect"><?=t('E-mail');?></label>
								...
								<div class="col-xl-12 col-lg-12 col-md-12 mb-1" style='background: #ececec;padding-top: 15px;'>
									<div class="row">
											...
											<?php $date = date('Y-m-d', strtotime('-1 day +1 year', time()));?>
                    ...
                    <div class="card-body card-dashboard">
						<table class="table table-striped table-bordered dataex-html5-export">
							...
							<tbody>
                                ...
                                <tr>
                                    <td><a href="/client/detail?id=<?=$clients->id;?>&firmid=<?=$_GET['id'];?>"><?=$clients->name;?></a></td>
									...
									<td>
										<div class="form-group pb-1">
											<input type="checkbox" data-size="sm" id="switchery"  class="switchery" data-id="<?=$clients->id;?>"  <?php if($clients->active==1){echo "checked";}?> <?php if (Yii::app()->user->checkAccess('client.update')==0){?>disabled<?php }?>/>
										</div>
									</td>
							...
							<?php foreach($tclient as $tclientx){
								$transfer=Client::model()->find(array('condition'=>'id='. $tclientx->mainclientid))
								?>
                                <tr>
