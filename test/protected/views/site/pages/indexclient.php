...
else
{
	...
	$conformityk=Conformity::model()->findAll(array('condition'=>'clientid='.$ax->clientbranchid.' and (statusid=1 or statusid=2 or statusid=3 or statusid=6 or statusid=4) and (date>='.$starttime.' and date<='.$finishtime.')')); // branch
}
	?>
