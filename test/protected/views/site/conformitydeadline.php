                ...
                <div class="card-content collapse show">
                  <div class="card-body card-dashboard">
                      ...
                      <table class="table table-striped table-bordered dataex-html5-export table-responsive">
                        ...
                        <tbody>
							...
							<tr>
								 ...
								 <td><?php $username=User::model()->find(array('condition'=>'id='.$conformity[$i]['userid']));
					...
					<td><?=$depart?></td>
								...
								<td><?php $activitiondef=Conformityactivity::model()->find(array('condition'=>'conformityid='.$conformity[$i]['id'],))->definition;
