                  ...
                  <div class="card-body">
                    <div class="tab-content px-1 pt-1">
                        <div role="tabpanel" class="tab-pane active" id="tabIcon21" aria-expanded="true"
                            ...
                            <?php $select=Yii::app()->db->createCommand('SELECT * FROM superlogs ORDER BY id DESC LIMIT 2000')->queryAll(); ?>
                            <div style="width:100%">
                                    ...
                                    <?php foreach ($select as $log)
                                	{
                                	    ...
                                	    if($data['Workorders']) {
                                    	    foreach($data['Workorders'] as $workorder)
                                    	    {
                                    	        ...
                                    	        foreach($workorder['workordermonitors'] as $monitor) if($monitor['checkdate'] > 0) $monitorsChecked = $monitorsChecked.$monitor['monitorno'].', ';
