					...
					<div class="card-body">
					 <?php
						...
						?>
							...
							<li class="nav-item">
									<?php
										$selectedtab=''; // A�a��dadaki foreach authpackagesta da kullan�l�yor l�tfen silmeyelim
										...
										<div class="card-header">
										  ...
										  <div class="heading-elements">
											<ul class="list-inline mb-0">
											  ...
											  <?php if(isset($_GET['package']) && $_GET['package']!='Default'&&$_GET['package']!=''){?><li> <a class="btn btn-danger btn-sm" style="color:#fff;" onclick="openmodalpaketsil(this)" data-id="<?=$_GET['package'];?>" style="float:right;"><i style="color:#fff;padding-right: 7px;" class="fa fa-trash"></i>Delete Package</a></li>
											  <?php }?>
											</ul>
										  </div>
										</div>
													...
													{ 
														...
														<?Yii::app()->getModule('translate')->language->autoload();?>
																	...
																	<?php 
																	  ...
																	  {
																		?>
																	 <?php if(isset($_GET['package']) && ($_GET['package']=='Default' ||$_GET['package']=='Superadmin' )){?> <a class="btn btn-danger btn-sm" onclick="openmodalsil(this)" data-child="<?=$item->name?>" data-parent="<?=$_GET['package'];?>" style="float:right;"><i style="color:#fff; " class="fa fa-trash"></i></a>
																	 <?php }?>
																	  <?php 
																	  }
																		?>
