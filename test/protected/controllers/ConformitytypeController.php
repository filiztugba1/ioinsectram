...
class ConformitytypeController extends Controller
{
		...
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','deleteall'
                        ,'index2','conformitytypelist','conformitytypecreateupdate','conformitytypedelete','conformitytypedeleteall','conformitytypeisactive','conformitytypedetail'),
				'users'=>array('*'),
			),
  ...
  public function actionConformitytypelist()
  {
     $yetki=AuthAssignment::model()->accesstoken();
   
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->conformitytypelist($_POST);
    ...
    public function actionConformitytypedetail()
  {
    ...
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->conformitytypedetail($_POST);
      echo json_encode($response);
      exit;
    }
    json_encode($yetki);
    ...
    public function actionConformitytypecreateupdate()
  {
     $yetki=AuthAssignment::model()->accesstoken();
   
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->conformitytypecreateupdate($_POST);
      echo json_encode($response);
      exit;
    }
    json_encode($yetki);
   ...
   public function actionConformitytypedelete()
  {
     $yetki=AuthAssignment::model()->accesstoken();
   
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->conformitytypedelete($_POST);
      echo json_encode($response);
      exit;
    }
    json_encode($yetki);
    ...
    public function actionConformitytypedeleteall()
  {
     $yetki=AuthAssignment::model()->accesstoken();
   
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->conformitytypedeleteall($_POST);
      echo json_encode($response);
      exit;
    }
    json_encode($yetki);
  ...
  public function actionConformitytypeisactive()
  {
     $yetki=AuthAssignment::model()->accesstoken();
   
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->conformitytypeisactive($_POST);
      echo json_encode($response);
      exit;
    }
    json_encode($yetki);
