...
class MonitoringController extends Controller
{
		...
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','monitoringtypecreate','monitoringlocationcreate','monitoringlist','monitoringinput','deleteall'
                        ,'monitorlist','monitorcreateupdate','monitordelete','monitordetail','monitordeleteall','monitorisactive','monitornumber'),
				'users'=>array('*'),
			),
    ...
    public function actionMonitorlist() 
  {
    ...
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->monitorlist($_POST);
   ...
   public function actionMonitorcreateupdate()
  {
    $yetki=AuthAssignment::model()->accesstoken();
   
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->monitorcreateupdate($_POST);
      echo json_encode($response);
      exit;
    }
    json_encode($yetki);
   ...
   public function actionMonitordelete()
  {
    $yetki=AuthAssignment::model()->accesstoken();
   
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->monitordelete($_POST);
      echo json_encode($response);
      exit;
    }
    json_encode($yetki);
     ...
     public function actionMonitordetail()
  {
    ...
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->monitordetail($_POST);
      echo json_encode($response);
      exit;
    }
    json_encode($yetki);
    ...
    public function actionMonitordeleteall()
  {
    ...
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->monitorDeleteAll($_POST);
      echo json_encode($response);
      exit;
    }
    json_encode($yetki);
    ...
    public function actionMonitorisactive()
  {
     $yetki=AuthAssignment::model()->accesstoken();
   
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->monitorisactive($_POST);
      echo json_encode($response);
      exit;
    }
    json_encode($yetki);
   ...
   public function actionMonitornumber()
  {
     $yetki=AuthAssignment::model()->accesstoken();
   
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->monitornumber($_POST);
      echo json_encode($response);
      exit;
    }
    json_encode($yetki);
