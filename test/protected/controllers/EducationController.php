...
class EducationController extends Controller
{
		...
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','deleteall'
                        ,'educationlist','educationcreateupdate','educationdelete','educationdetail','educationdeleteall'),
				'users'=>array('*'),
			),
  ...
  public function actionEducationlist()
  {
    ...
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->educationlist($_POST);
   ...
   public function actionEducationcreateupdate()
  {
    $yetki=AuthAssignment::model()->accesstoken();
   
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->educationcreateupdate($_POST);
      echo json_encode($response);
      exit;
    }
    json_encode($yetki);
   ...
   public function actionEducationdelete()
  {
    ...
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->educationdelete($_POST);
      echo json_encode($response);
      exit;
    }
    json_encode($yetki);
     ...
     public function actionEducationdetail()
  {
    ...
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->educationdetail($_POST);
      echo json_encode($response);
      exit;
    }
    json_encode($yetki);
    ...
    public function actionEducationdeleteall()
  {
    ...
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->educationdeleteall($_POST);
      echo json_encode($response);
      exit;
    }
    json_encode($yetki);
