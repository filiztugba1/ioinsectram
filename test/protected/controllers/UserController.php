...
class UserController extends Controller
{
		...
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','staffsearch','editprofile','company','usertable','tableayar','userlog',
                        'userlist','usercreateupdate','userdetay'),
				'users'=>array('*'),
			),
  ...
  /////////////// yeni apiii /////////
    public function actionUserlist() // admin girişinde firm listesini çekmek için kullanılır.
  {
    ...
    if($yetki['status'])
    {
      $response=NewUserModel::model()->userlist($_POST);
  ...
  public function actionUserdetay() // admin girişinde firm listesini çekmek için kullanılır.
  {
  ...
  public function actionUsercreateupdate() // admin girişinde firm listesini çekmek için kullanılır.
  {
    ...
    if($yetki['status'])
    {
      $response=NewUserModel::model()->usercreateupdate($_POST);
      echo json_encode($response);
      exit;
    }
    json_encode($yetki);
