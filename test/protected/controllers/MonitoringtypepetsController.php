...
class MonitoringtypepetsController extends Controller
{
		...
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','deleteall'
                           ,'monitoringtypepetslist','monitoringtypepetscreateupdate','monitoringtypepetsdelete','monitoringtypepetsdetail','monitoringtypepetsdeleteall','monitoringtypepetsisactive'),
				'users'=>array('*'),
			),
  ...
  ////// YENİ APİLER //////
    public function actionMonitoringtypepetslist() 
  {
    $yetki=AuthAssignment::model()->accesstoken();
   
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->monitoringtypepetslist($_POST);
   ...
   public function actionMonitoringtypepetscreateupdate()
  {
    ...
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->monitoringtypepetscreateupdate($_POST);
      echo json_encode($response);
      exit;
    }
    json_encode($yetki);
   ...
   public function actionMonitoringtypepetsdelete()
  {
    $yetki=AuthAssignment::model()->accesstoken();
   
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->monitoringtypepetsdelete($_POST);
      echo json_encode($response);
      exit;
    }
    json_encode($yetki);
     ...
     public function actionMonitoringtypepetsdetail()
  {
    ...
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->monitoringtypepetsdetail($_POST);
      echo json_encode($response);
      exit;
    }
    json_encode($yetki);
    ...
    public function actionMonitoringtypepetsdeleteall()
  {
    ...
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->monitoringtypepetsDeleteAll($_POST);
      echo json_encode($response);
      exit;
    }
    json_encode($yetki);
    ...
    public function actionMonitoringtypepetsisactive()
  {
     $yetki=AuthAssignment::model()->accesstoken();
   
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->monitoringtypepetsisactive($_POST);
      echo json_encode($response);
      exit;
    }
    json_encode($yetki);
