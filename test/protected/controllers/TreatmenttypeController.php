...
class TreatmenttypeController extends Controller
{
		...
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','deleteall'
                         ,'index2','treatmenttypelist','treatmenttypecreateupdate','treatmenttypedelete','treatmenttypedetail','treatmenttypedeleteall','treatmenttypeisactive'),
				'users'=>array('*'),
			),
  ...
  public function actionIndex2()
  {
    ...
    public function actionTreatmenttypelist() 
  {
    $yetki=AuthAssignment::model()->accesstoken();
   
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->treatmenttypelist($_POST);
   ...
   public function actionTreatmenttypecreateupdate()
  {
    ...
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->treatmenttypecreateupdate($_POST);
      echo json_encode($response);
      exit;
    }
    json_encode($yetki);
   ...
   public function actionTreatmenttypedelete()
  {
    $yetki=AuthAssignment::model()->accesstoken();
   
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->treatmenttypedelete($_POST);
      echo json_encode($response);
      exit;
    }
    json_encode($yetki);
     ...
     public function actionTreatmenttypedetail()
  {
    ...
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->treatmenttypedetail($_POST);
      echo json_encode($response);
      exit;
    }
    json_encode($yetki);
    ...
    public function actionTreatmenttypedeleteall()
  {
    ...
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->treatmenttypeDeleteAll($_POST);
      echo json_encode($response);
      exit;
    }
    json_encode($yetki);
    ...
    public function actionTreatmenttypeisactive()
  {
     $yetki=AuthAssignment::model()->accesstoken();
   
    if($yetki['status'])
    {
      $response=NewParamsModel::model()->treatmenttypeisactive($_POST);
      echo json_encode($response);
      exit;
    }
    json_encode($yetki);
