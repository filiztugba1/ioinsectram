...
/**
 * This is the model class for table "visittype".
 *
 * The followings are the available columns in table 'visittype':
 * @property integer $id
...
class Visittype extends CActiveRecord
{
	...
	{
		$type=Visittype::model()->find(array('condition'=>'id=:id','params'=>array('id'=>$id)));
		if($type)
		{
	 ...
	 * @return Visittype the static model class
	 */
