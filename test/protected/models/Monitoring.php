...
class Monitoring extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('barcodeno, definationlocation', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, dapartmentid, subid, clientid, mno, barcodeno, mtypeid, mlocationid, definationlocation, active, createdtime, activetime, passivetime', 'safe', 'on'=>'search'),
		);
	}
